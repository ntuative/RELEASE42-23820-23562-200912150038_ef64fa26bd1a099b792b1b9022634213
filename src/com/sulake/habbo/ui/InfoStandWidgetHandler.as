   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_135,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_115,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_134,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_142,onPetInfo);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetCommandsUpdateEvent.const_131,onPetCommands);
            }
         }
         _container = param1;
         if(param1 == null)
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_135,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_115,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_134,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_142,onPetInfo);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetCommandsUpdateEvent.const_131,onPetCommands);
         }
      }
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_603);
               _loc6_.id = param1.id;
               ...
               {
                  _loc20_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_323);
                  if(param1.category == RoomObjectCategoryEnum.const_32)
                  {
                     _loc21_ = _container.sessionDataManager.getFloorItemData(_loc20_);
                  }
                  else if(param1.category == RoomObjectCategoryEnum.const_29)
                  {
                     _loc21_ = _container.sessionDataManager.getWallItemData(_loc20_);
                  }
                  if(_loc21_ != null)
                  {
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_316)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc9_.webID);
                  return null;
               }
               if(_loc9_.type == RoomObjectTypeEnum.const_367)
               {
                  _loc10_ = "null";
               ...
               {
                  if(_loc9_.type != RoomObjectTypeEnum.const_818)
                  {
                     return null;
                  }
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_673);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_193)
               {
                  _loc11_.realName = _container.sessionDataManager.realName;
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_217)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_520);
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1177;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_884;
                  }
                  if(!_loc25_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_833;
                  }
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1316);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_575.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_575.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_520);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_102];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_318);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_605);
         _loc1_.push(RoomWidgetUserActionMessage.const_574);
         _loc1_.push(RoomWidgetUserActionMessage.const_368);
         _loc1_.push(RoomWidgetUserActionMessage.const_567);
         _loc1_.push(RoomWidgetUserActionMessage.const_587);
         _loc1_.push(RoomWidgetUserActionMessage.const_666);
         _loc1_.push(RoomWidgetUserActionMessage.const_682);
         _loc1_.push(RoomWidgetUserActionMessage.const_667);
         _loc1_.push(RoomWidgetFurniActionMessage.const_247);
         _loc1_.push(RoomWidgetFurniActionMessage.const_525);
         _loc1_.push(RoomWidgetFurniActionMessage.const_652);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_548);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_594);
         _loc1_.push(RoomWidgetUserActionMessage.const_1258);
         _loc1_.push(RoomWidgetPetCommandMessage.const_606);
         _loc1_.push(RoomWidgetPetCommandMessage.const_613);
         _loc1_.push(RoomWidgetUserActionMessage.const_532);
         _loc1_.push(RoomWidgetUserActionMessage.const_358);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_102:
      ...
      public function dispose() : void
      {
         ...
         if(var_575 != null)
         {
            _loc1_ = var_575.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_575.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_449)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_318:
            ...
            case RoomWidgetUserActionMessage.const_498:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_889,_loc3_.name);
               _container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_605:
               _container.sessionDataManager.ignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_574:
               _container.sessionDataManager.unignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_368:
               _container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_567:
               _container.roomSession.banUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_587:
            ...
            case RoomWidgetUserActionMessage.const_666:
               ...
               break;
            case RoomWidgetUserActionMessage.const_682:
