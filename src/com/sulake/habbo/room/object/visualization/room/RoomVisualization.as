package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1318:int = 13421772;
      
      private static const const_1098:int = 16777215;
      
      public static const const_1262:int = 10066329;
      
      private static const const_1099:int = 13421772;
      
      public static const const_1112:int = 16777215;
      
      private static const const_1391:int = 0;
      ...
      public static const const_1136:int = 13421772;
       
      
      private var var_1134:String = null;
      ...
      private var var_1022:uint = 16777215;
      
      private var var_84:RoomPlaneParser = null;
      
      private var var_1135:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            _loc8_ = var_109[_loc4_] as RoomPlane;
            if(_loc8_ != null)
            {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1361;
               }
               if(var_84.getPlaneType(_loc4_) == RoomPlaneData.const_137)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_249 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_542);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_496);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_703);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_927);
            if(_loc8_ != var_2121)
            {
               updatePlaneMasks(_loc8_);
               var_2121 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_645));
            if(_loc9_ != var_1022)
            {
               var_1022 = _loc9_;
            }
            var_2122 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_977));
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            _loc11_ = var_109[_loc4_] as RoomPlane;
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_173)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_2122)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_1022 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_1022 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_1022 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_926);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_799);
         var _loc7_:int = 0;
         while(_loc7_ < var_84.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_137)
            {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_249,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_173,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
               ...
               {
                  _loc13_.color = const_1136;
               }
               else
               {
                  _loc13_.color = const_1262;
               }
               if(_data != null)
               {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_109.length)
            {
               _loc2_ = var_109[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_249 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_173 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         while(_loc4_ < var_109.length)
         {
            _loc3_ = var_109[_loc4_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            {
               _loc9_ = 0;
               while(_loc9_ < var_109.length)
               {
                  _loc3_ = var_109[_loc9_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_249 || _loc3_.type == RoomPlane.const_173 && _loc8_ == RoomPlaneBitmapMaskData.const_189)
                  {
