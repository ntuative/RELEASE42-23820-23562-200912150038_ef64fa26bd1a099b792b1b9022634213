package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1473:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_259:ToolbarBarMenuAnimator;
      
      private var var_1474:Number = 5;
      
      private var var_267:Array;
      
      private var var_145:Number = 50;
      
      private var var_1236:Number = 0;
      
      private var var_2235:Array;
      
      private var _toolbarMarginTop:Number = 1;
      
      private var var_1002:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_145 = _window.width;
         var_202 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_904,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1002 = String(_loc7_.relocate_by_drag.@state) == "HabboAvatarRenderLib_fx15";
         if(var_1002)
         {
         ...
         var_1236 = _loc7_.toolbar.@margin_bottom;
         var_1473 = _loc7_.toolbar.@min_group_margin;
         var_1474 = _loc7_.toolbar.@margin_to_extrabar;
         var_259 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_267,param1,param2,_window,var_259);
         createGroupsFromXmlList(_loc9_,var_561,param1,param2,var_202,var_259);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_145,var_480,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_145;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_202.x = var_145 + var_1474;
               var_202.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_145;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_145;
               _window.y = 0;
               var_202.x = 0;
               var_202.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_145;
               _window.x = 0;
               _window.y = 0;
               var_202.x = 0;
               var_202.y = var_145 + var_1474;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_145;
               _window.x = 0;
               _window.y = _loc1_.height - var_145;
               var_202.x = 0;
               var_202.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1473,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1236) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1473,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1236) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_145);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_145)
         {
            return "RIGHT";
         }
         if(param2 <= var_145)
         ...
         if(param2 >= _loc3_.height - var_145)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_145,var_480);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_561.length)
         {
            _loc2_ = var_561[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_480);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_145,var_480);
         }
      }
