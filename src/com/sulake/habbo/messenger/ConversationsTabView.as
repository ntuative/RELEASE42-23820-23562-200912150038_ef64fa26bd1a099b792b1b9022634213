package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         super();
         var_144 = param1;
         var_34 = IWindowContainer(param2.findChildByName("content"));
         var_836 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_34.findChildByName("convo_bg"));
         _loc3_.bitmap = var_144.getButtonImage("convo_bg");
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = var_144.conversations.openConversations;
         var _loc2_:int = 0;
         while(_loc2_ < getTabCount())
         {
            refreshTabContent(_loc2_,_loc1_[var_144.conversations.startIndex + _loc2_]);
            _loc2_++;
         }
         while(true)
         {
      ...
      {
         return var_144.conversations.startIndex > 0;
      }
      
      private function refreshTabBg(param1:IWindowContainer, param2:int, param3:String) : void
      {
         var_144.refreshButton(param1,param3,true,onTabClick,param2);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            var_144.conversations.changeStartIndex(-1);
         }
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_170 ? var_144.conversations.findConversation(param2.id) : var_144.conversations.openConversations[_loc3_ + var_144.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
            var_144.conversations.setSelected(_loc4_);
         }
         var_144.messengerView.refresh(true);
      }
      
      private function refreshArrow(param1:IWindowContainer, param2:int, param3:Boolean) : void
      {
         var_144.refreshButton(param1,!!param3 ? "next" : "prev",true,null,0);
      }
      
      private function refreshFigure(param1:IWindowContainer, param2:String) : void
      {
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboMessenger.const_170) as IBitmapWrapperWindow;
         ...
         {
            _loc3_.bitmap = var_144.getAvatarFaceBitmap(param2);
            _loc3_.visible = true;
         }
      }
      ...
      {
         return var_144.conversations.openConversations.length - var_144.conversations.startIndex > getTabCount();
      }
      ...
      {
         var _loc3_:IWindowContainer = var_836.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = IWindowContainer(var_144.getXmlWindow("tab_entry"));
            _loc3_.y = 1;
            var_836.addChild(_loc3_);
         }
         hideChildren(_loc3_);
         if(param2 == null)
         {
