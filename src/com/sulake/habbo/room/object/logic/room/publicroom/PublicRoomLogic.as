package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_423,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_299,"");
         _loc2_.setString(RoomObjectVariableEnum.const_647,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_423,Number(false));
         _initialized = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_772:
                  _loc2_.setString(RoomObjectVariableEnum.const_299,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_647,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_423,Number(true));
                  var_1014 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_777);
            }
         }
      }
      ...
      {
         super.update();
         if(var_1014 > 0 && getTimer() > var_1014)
         {
            adDelayTimeout();
            var_1014 = 0;
         }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_354)
               {
            ...
            case MouseEvent.ROLL_OVER:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_354)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_296,_loc5_,_loc6_));
               }
               break;
