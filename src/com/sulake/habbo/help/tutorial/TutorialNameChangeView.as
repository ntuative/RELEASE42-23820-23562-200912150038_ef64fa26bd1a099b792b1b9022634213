package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1461:uint = 13232628;
      ...
      private var var_832:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_55.localization.registerParameter("help.tutorial.name.available","name",var_399);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_399 = var_55.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_55.localization.registerParameter("help.tutorial.name.confirmation","name",var_399);
         }
         if(var_264 == null)
         {
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_832 = new NameSuggestionListRenderer(var_55);
         var _loc6_:int = var_832.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1461;
