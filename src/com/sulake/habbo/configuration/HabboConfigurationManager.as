package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private var var_955:Dictionary;
      ...
      {
         (_context as CoreComponent).error("Could not load external variables. Client startup failed!",true,CoreComponent.const_1143);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_955[param1] as String;
         return _loc2_ != null;
      }
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1415.indexOf(param1) < 0)
         {
            var_955[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         _initialized = true;
         this.events.dispatchEvent(new Event(HabboConfigurationEvent.const_16));
         if(var_1883)
         {
      ...
      {
         var _loc4_:String = var_955[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
