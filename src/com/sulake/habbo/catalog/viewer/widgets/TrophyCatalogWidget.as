package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_466:String = "g";
      
      private var var_199:int = 0;
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_388.getWithIndex(var_199);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_466);
            if(_loc3_ == null)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_87.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
         var_87.invalidate();
      }
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_388.getValue(_loc6_) == null)
            {
               var_388.add(_loc6_,new Map());
            }
            _loc8_ = var_388.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_388.getWithIndex(var_199);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_466);
            if(_loc3_ == null)
            {
