package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1338:Point;
      
      private var var_1583:Array;
      
      private var var_503:IItemGridWindow;
      
      private var var_87:IBitmapWrapperWindow;
      
      private var var_1246:ITextWindow;
      
      private var var_1066:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_503 != null)
         {
            var_503.visible = false;
            var_503.destroyGridItems();
         }
         if(var_1066 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1246.text = "${" + _loc3_.name + "}";
            var_1247.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1246.text = "${" + _loc2_.localizationId + "}";
            var_1247.text = "${" + _loc2_.localizationId + "}";
         }
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            setPreviewFromAsset(ProductImageConfiguration.const_34[_loc2_.localizationId]);
         }
         else
         {
            ...
            {
               case Offer.const_361:
                  _loc4_ = var_1065.clone();
                  if(var_503 != null)
                  {
                     var_503.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_503,var_1066,var_1294);
                  }
                  break;
               case Offer.const_390:
               case Offer.const_464:
                     ...
                     case ProductTypeEnum.const_261:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_322,AvatarAction.const_493);
                              _loc13_.appendAction(AvatarAction.const_664,_loc6_.productClassId);
      ...
      {
         var_1246 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1247 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1338 = new Point(var_87.x,var_87.y);
         var_503 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1066 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_503 == null)
         {
         ...
         var_1065 = _loc2_.content as BitmapData;
