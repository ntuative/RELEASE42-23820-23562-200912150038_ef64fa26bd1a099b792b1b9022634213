package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_817:RoomObjectLocationCache;
      ...
      private var var_1956:Number = -10000000;
      
      private var var_1954:Number = -10000000;
      
      private var var_20:uint = 0;
      
      private var var_978:int;
      
      private var var_261:Sprite;
      
      private var var_974:IRoomRenderingCanvasMouseListener = null;
      
      private var var_975:Point;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_817 = new RoomObjectLocationCache(_loc6_);
         var_295 = new Map();
      ...
      public function update() : void
      {
         if(var_977 == 0)
         {
            checkMouseHits(var_975.x,var_975.y,MouseEvent.MOUSE_MOVE);
         }
         var_977 = 0;
         ++var_1442;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_261 != null)
         {
            var_261.graphics.clear();
         }
         else
         {
            var_261 = new Sprite();
            var_261.name = "mask";
            _master.addChild(var_261);
         }
         var_261.graphics.beginFill(0);
         var_261.graphics.drawRect(0,0,param1,param2);
         var_978 = param1;
         var_976 = param2;
      ...
      {
         var _loc11_:Number = param1 - var_978 / 2;
         var _loc12_:Number = param2 - var_976 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc8_ < var_138.length)
         {
            var_138.splice(_loc8_);
         }
         _loc3_ = getTimer();
         ErrorReportStorage.addDebugData("Canvas rendering split time","Canvas render split: " + (_loc3_ - _loc2_));
         var _loc12_:String = " ";
         ...
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorting sprites" + _loc12_ + var_138.length);
         var_138.sortOn("z",0 | 0);
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorted sprites" + _loc12_ + var_138.length);
         var _loc13_:* = null;
         var _loc14_:int = 0;
         _loc7_ = 0;
         while(_loc7_ < _loc8_)
         {
            _loc13_ = var_138[_loc7_] as SortableSprite;
            updateSprite(_loc7_,_loc13_);
            _loc13_.bitmapData = null;
            _loc7_++;
         }
         cleanSprites(var_138.length);
         var_1955 = param1;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_471.length)
            {
               cleanSprite(var_471[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_471 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_295 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_295.getKey(_loc1_);
            _loc3_ = var_295.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_974 != null)
                  {
                     var_974.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1442,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_138.length)
         {
            return null;
         }
         return var_138[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1956 || param2 != var_1954)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_471.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_817.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc7_ += int(var_978 / 2);
         _loc8_ += int(var_976 / 2);
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:int = 0;
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_978 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_976))
                     {
                        if(param3 + _loc10_ < var_138.length)
                        {
                           _loc11_ = var_138[param3 + _loc10_];
