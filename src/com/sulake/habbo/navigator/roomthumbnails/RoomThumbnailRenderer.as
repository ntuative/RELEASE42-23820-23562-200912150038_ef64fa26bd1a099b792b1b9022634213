package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1014:int = -16;
      
      private static const const_734:int = 32;
      
      private static const const_1013:int = 8;
      
      public static const const_352:int = 10;
      
      private static const const_1015:int = 40;
      ...
      private var var_1616:Dictionary;
      
      private var var_737:ThumbnailImageConfigurations;
      
      private var var_1081:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_891 = new Dictionary();
         super();
         _navigator = param1;
         var_737 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,0 | (!!param3 ? HabboWindowParam.const_36 : HabboWindowParam.const_40),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_737.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1014,_loc4_.y + const_1015 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1616[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_737.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_737.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_737.getImage(ThumbnailEditorModel.const_51,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_734 / 2);
         return new Point(param1 * const_734 + _loc3_,param2 * const_1013);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_352)
         {
            if(false)
            {
               refreshObj(param1,var_891[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1081 == null)
         {
            var_1081 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1081,var_1081.rect,new Point(0,0),null,null,true);
      }
   }
}
