package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1579:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_571 = param6;
         var_571.events.addEventListener(BadgeImageReadyEvent.const_115,onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_738.length)
         {
            if(var_738[_loc2_] == param1)
            {
               var_738.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_245[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_245.length)
               {
                  if((var_245[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_245[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_242 && false)
         {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_571.getBadgeImage(param1);
            var_245.push(_loc8_);
            if(param2)
            {
