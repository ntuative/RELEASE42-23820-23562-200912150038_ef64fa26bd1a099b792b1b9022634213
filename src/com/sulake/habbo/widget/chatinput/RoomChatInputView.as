package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1366:int = 5;
      
      private static const const_484:int = 16;
      
      private static const const_1011:int = 20;
      
      private static const const_339:int = 10;
      
      private static const const_1010:int = 40;
      ...
      private var var_391:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_884 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1586 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1585 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_598 = new Timer(1000,1);
         var_598.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_726 = new Timer(5000,1);
         var_726.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_126,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_186,onInputChanged);
         _window.addEventListener(WindowEvent.const_350,onWindowMoved);
         var_1067 = true;
         var_127 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1584 = _loc2_.width + const_484 + _loc6_.width + const_1011;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1010,_loc8_.width) + const_484);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_884 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_127 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_391);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_391);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_431);
