package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1376:int = 60000;
      ...
      private var var_769:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_75.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_131.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_131.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_75.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_608)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_360)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_75.getParts(param1,(var_769 as AvatarImage).getFigure(),_loc6_,var_1137,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_75.getCanvas(var_194,var_1137);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1227[param1])
            {
            ...
            _loc10_ = var_194 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_194 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_75.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_835 || _loc32_ == AvatarAction.const_494) && (_loc6_ == AvatarBodyPartType.const_303 || _loc6_ == AvatarBodyPartType.const_1265 || _loc6_ == AvatarBodyPartType.const_1113) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_194 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_75.getActiveBodyPartIds(param1);
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_131 != null)
         {
            _loc2_ = var_131.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_131.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_75.getBodyPartsUnordered(param1);
