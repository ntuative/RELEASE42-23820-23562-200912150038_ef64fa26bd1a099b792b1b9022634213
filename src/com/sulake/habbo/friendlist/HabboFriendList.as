package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_170:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_1721:IAvatarRenderManager;
      
      private var var_1372:AvatarSearchResults;
      
      private var var_144:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_757:FriendRequests;
      
      private var var_1559:int;
      
      var var_333:FriendCategories;
      
      private var var_189:IHabboToolbar;
      
      private var var_1719:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_402:FriendListTabs;
      
      private var var_1720:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1373:OpenedToWebPopup;
      ...
      {
         var_1719 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_333 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1372 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1373 == null)
         {
            var_1373 = new OpenedToWebPopup(this);
         }
         var_1373.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_757.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_757.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_402.findTab(FriendListTab.const_100).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_757.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_189.events.dispatchEvent(_loc1_);
      }
      ...
      private function method_6(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_144 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_333.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_757 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_333.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_333.addCategory(new FriendCategory(FriendCategory.const_778,getText("friendlist.friends")));
         var_333.addCategory(new FriendCategory(FriendCategory.const_362,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_333.addFriend(new Friend(_loc4_));
         }
         var_402 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_333.onFriendListUpdate(param1);
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         queueInterface(new IIDHabboMessenger(),method_6);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_75);
      ...
      {
         var _loc2_:IAvatarImage = var_1721.createAvatarImage(param1,AvatarScaleType.const_101);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1721 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_757.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_402.findTab(FriendListTab.const_100);
      ...
      {
         var_1720 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_333.getFriendCount(param1,param2);
      }
      ...
      {
         var _loc1_:String = var_170.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboAvatarRenderLib_fx15";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_402.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_287));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_75:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_284:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH);
                     break;
                  case FriendListTab.const_100:
      ...
      {
         var_189 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         return var_170.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1372.searchReceived(_loc2_.friends,_loc2_.others);
