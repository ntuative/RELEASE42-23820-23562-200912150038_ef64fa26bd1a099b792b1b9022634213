package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1377:IMessageComposer;
      ...
      private var var_1076:Dictionary;
      ...
      {
         var_735 = IWindowContainer(var_55.getXmlWindow("chatlog_roomheader"));
         var_736 = IWindowContainer(var_55.getXmlWindow("chatlog_chatline"));
         ...
         var_55.connection.send(var_1377);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_735.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_736.clone());
         _loc4_.color = var_1076[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
