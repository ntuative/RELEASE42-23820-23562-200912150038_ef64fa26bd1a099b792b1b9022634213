package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_844:String = "AssetLibraryReady";
      
      public static const const_1326:String = "AssetLibraryUnloaded";
      
      public static const const_446:String = "AssetLibraryLoaded";
      
      public static const const_1163:String = "AssetLibraryLoadError";
       
      
      private var var_438:XML;
      ...
      private var var_370:Dictionary;
      ...
      private var var_437:Boolean = true;
      
      private var var_315:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_370 = new Dictionary(false);
         var_616 = new Dictionary(false);
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_370)
         {
            _loc2_ = var_370[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_370[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_616)
         {
            delete var_616[_loc1_];
         }
         if(var_1 != null)
         {
            var_1.dispose();
         ...
         var_283 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1326));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_438 = _loc2_.manifest.copy();
         var_315 = _loc2_.resource;
         if(var_437)
         {
            AssetLibrary.fetchLibraryContents(this,var_438,var_315);
         }
         var_283 = true;
         dispatchEvent(new Event(AssetLibrary.const_446));
         dispatchEvent(new Event(AssetLibrary.const_844));
         if(var_437)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_370[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_874,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_856,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_932,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_839,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_370[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      {
         return param1 < var_316.length ? getAssetByName(var_316[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1163));
      }
      ...
      {
         var _loc2_:Class = var_616[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_873);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_438.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_315[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_370[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_316.splice(var_316.indexOf(_loc2_),1);
      ...
      {
         return var_315 != null ? false : false;
      }
   }
}
