package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var _loc1_:XmlAsset = var_317.assets.getAssetByName("doorbell") as XmlAsset;
         var_58 = (var_317.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_58 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         _list = var_58.findChildByName("user_list") as IItemListWindow;
         var_58.visible = false;
      ...
      {
         var _loc6_:* = null;
         var _loc3_:XmlAsset = var_317.assets.getAssetByName("doorbell_list_entry") as XmlAsset;
         var _loc4_:IWindowContainer = var_317.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function update() : void
      {
         ...
         if(_list != null)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < var_317.users.length)
            {
               _list.addListItem(createListItem(var_317.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
