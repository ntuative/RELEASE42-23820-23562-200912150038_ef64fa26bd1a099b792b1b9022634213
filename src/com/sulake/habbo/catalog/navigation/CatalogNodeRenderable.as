package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1049:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1413:XML;
      
      private static var var_1414:XML;
       
      
      private var var_2217:IWindowContainer;
      ...
      private var var_1412:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1412 == 4294967295)
            {
               var_1412 = _loc1_.color;
            }
            _loc1_.color = const_1049;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1304;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1413) as IWindowContainer;
         }
         else
         {
      ...
      {
         _list = navigator.catalog.windowManager.buildFromXML(var_1414) as IItemListWindow;
         if(_list == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1287;
            }
         }
      }
