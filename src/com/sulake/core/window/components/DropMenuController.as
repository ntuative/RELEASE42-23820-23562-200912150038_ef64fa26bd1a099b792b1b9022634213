package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_331:String = "_DROPMENU_TITLETEXT";
       
      
      private var var_147:DropMenuController;
      
      private var var_490:int = -1;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_147 == null || false)
         {
            var_147 = context.create(name + "::submenu","",WindowType.const_416,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
            var_147.setGlobalRectangle(_loc1_);
         }
         var_147.activate();
         return var_147;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_899)
         {
            if(param2 == var_147)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_396,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_306,var_86,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_490 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_490).setStateFlag(WindowState.const_45,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_577)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_491,getSubMenu(),subMenuEventProc);
                  var_577 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_414,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_490 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_304,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_147 != null)
            {
               _loc2_ = var_147.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      {
         return getChildByName(DropMenuController.const_331) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_577 = false;
            getTitleText().text = var_490 < var_491.length && var_490 > -1 ? "null" : caption;
         }
      }
   }
}
