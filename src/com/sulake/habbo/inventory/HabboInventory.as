package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1593:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_54.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_54.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_33 != null)
         {
            var_33.events.removeEventListener(RoomSessionEvent.const_86,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_461,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_54.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_92:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_461:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_54.getValue(InventoryCategory.const_578));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_54.getValue(InventoryCategory.const_68));
      }
      ...
      {
         var_205.clubPeriods = param1;
         var_205.clubDays = param2;
         var_205.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_935));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_54.getValue(InventoryCategory.const_165));
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_54.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:IInventoryModel = var_54.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1593);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_54.getValue(InventoryCategory.const_292));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_829.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_829.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < var_54.length)
         {
            _loc2_ = var_54.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_54.length)
         {
            _loc3_ = var_54.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_226:
               _view.toggleCategoryView(InventoryCategory.const_68,false);
         }
      }
      
      public function get pixelBalance() : int
      {
         return var_205.pixelBalance;
      }
      ...
      {
         return TradingModel(var_54.getValue(InventorySubCategory.const_226));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_571 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_829.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_205.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_54.getValue(InventoryCategory.const_460) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1336 = new IncomingMessages(this);
      ...
      {
         return var_205.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_205.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_54.getValue(InventoryCategory.const_242));
      }
      ...
      {
         var_33 = IRoomSessionManager(param2);
         var_33.events.addEventListener(RoomSessionEvent.const_86,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionPropertyUpdateEvent.const_461,roomSessionEventHandler);
         ...
         var_54.add(InventoryCategory.const_460,_loc3_);
         ...
         var_54.add(InventoryCategory.const_68,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_571);
         var_54.add(InventoryCategory.const_242,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_54.add(InventoryCategory.const_578,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_571);
         var_54.add(InventoryCategory.const_292,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_54.add(InventorySubCategory.const_226,_loc8_);
         var _loc9_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_54.add(InventorySubCategory.RECYCLER,_loc9_);
         ...
         var_54.add(InventoryCategory.const_165,_loc10_);
