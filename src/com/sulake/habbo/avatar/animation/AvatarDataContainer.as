package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1865:uint;
      
      private var var_1347:uint;
      
      private var var_1431:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1431,var_1433,var_1432,_alphaMultiplier);
         var_952 = generatePaletteMapForGrayscale(var_1865,var_1867);
      }
      
      public function get reds() : Array
      {
         return var_952.getValue("reds") as Array;
      }
      ...
      {
         return var_952.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_952.getValue("greens") as Array;
      }
      ...
      {
         return var_952.getValue("alphas") as Array;
      }
