package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_129,param2,param3);
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_162,param2,param3);
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_138,param2,param3);
         attachImages();
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_pants":
                  ...
                  break;
               case "tab_shoes":
                  switchCategory(FigureData.const_162);
                  break;
               case "tab_belts":
