   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_189 + " " + _loc6_);
            if(var_189 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_979,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_189.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_632,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               ...
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_94,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_632,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_172,onCreditBalance);
         }
         var_25 = _container.inventory;
         if(var_25 != null)
         {
            (var_25 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_935,onAvatarEffectsChanged);
            (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_656,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            ...
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_94,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_94:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_94));
               break;
            case HabboHelpTutorialEvent.const_399:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_459));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_611);
         _loc1_.push(RoomWidgetDanceMessage.const_709);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_588);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_693);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_644);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_711);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_617);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_640);
         _loc1_.push(RoomWidgetStopEffectMessage.const_713);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1184);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_966);
         _loc1_.push(RoomWidgetToolbarMessage.const_577);
         _loc1_.push(RoomWidgetToolbarMessage.const_508);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_636);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1329);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_819);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_604);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_511);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_651);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_569);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1281);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_589);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_555);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_681);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_597));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_511:
               if(_container != null && false)
               {
                  _loc8_ = new HabboToolbarEvent(HabboToolbarEvent.const_62);
                  _loc8_.iconId = HabboToolbarIconEnum.MEMENU;
                  _container.toolbar.events.dispatchEvent(_loc8_);
               }
               break;
            case RoomWidgetWaveMessage.const_611:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_709:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_588:
               if(var_25 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_693:
               if(var_25 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_644:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_640:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_70 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_661)
               {
                  var_70.openCatalogPage(CatalogPageName.const_295,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_617:
               ...
               if(var_25 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_875:
                        var_70.openCatalogPage(CatalogPageName.const_1259,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_890:
                        var_25.toggleInventoryPage(InventoryCategory.const_242);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1330:
                        var_25.toggleInventoryPage(InventoryCategory.const_68);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1138:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_713:
            ...
            case RoomWidgetNavigateToRoomMessage.const_966:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_604:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_577:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_189)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_25 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_508:
               ...
               if(var_189)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_453,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_636:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_359,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_949));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_359,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1194));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_561));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_651:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_569:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_297,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_589:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_297,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_555:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_297,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_681:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_646));
               }
               break;
            default:
