package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function method_5(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = var_245.getValue(_loc2_.groupId);
         var_880[_loc2_.groupId] = _loc3_;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(var_245.getValue(_loc4_) != null)
            {
               var_245.remove(_loc4_);
            }
            var_245.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      {
         return var_245.getValue(param1);
      }
      ...
      {
         var _loc2_:HabboGroupDetails = var_880[param1];
         if(_loc2_ == null)
         {
      ...
      public function set communication(param1:IHabboCommunicationManager) : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new HabboGroupDetailsMessageEvent(method_5));
      }
