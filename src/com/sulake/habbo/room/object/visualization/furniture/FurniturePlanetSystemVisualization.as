package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_933);
      ...
      {
         if(param1 < var_540.length)
         {
            return var_540[param1].y;
         }
      ...
      private function getPlanet(param1:String) : FurniturePlanetSystemVisualizationPlanetObject
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_227.length)
         {
            _loc2_ = var_227[_loc3_];
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_227 != null)
         {
            ...
            {
               _loc2_ = var_227[_loc3_];
               _loc2_.update(var_540,var_1901,param1);
               _loc3_++;
            }
