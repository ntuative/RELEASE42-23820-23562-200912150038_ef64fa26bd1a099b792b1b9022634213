package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1301:uint = 1;
      
      public static const const_1338:uint = 2;
       
      
      private var var_789:IProtocolDecoder;
      
      private var var_944:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_944 = new WedgieEncoder();
         var_789 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1301)
            {
               _loc4_.position = 0;
               _loc6_ = var_789.getID(_loc4_);
