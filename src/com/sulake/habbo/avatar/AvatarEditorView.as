package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1517:IWindowContainer;
      
      public static var var_1290:IWindowContainer;
      
      public static var var_1035:int = 6710886;
      ...
      private var var_1488:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1290 == null)
         {
            ...
            var_1290 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1517 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1517 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_607 != null)
         {
            toggleCategoryView(var_607,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1488 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_607 = param1;
         var_1488.setSelected(var_1488.getSelectableByName(param1));
         _window.invalidate();
      }
