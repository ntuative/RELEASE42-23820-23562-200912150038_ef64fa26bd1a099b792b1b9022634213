package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_983:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_983.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_982)
         {
            ...
            var_661["null"] = new FigureData(this);
            var_661["null"] = new FigureData(this);
            _loc1_ = var_661["null"];
            _loc2_ = var_661["null"];
            ...
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_74);
            var_333 = new Map();
            var_333.add(AvatarEditorCategory.const_986,new GenericModel(this));
            var_333.add(AvatarEditorCategory.const_46,new HeadModel(this));
            var_333.add(AvatarEditorCategory.const_303,new TorsoModel(this));
            var_333.add(AvatarEditorCategory.const_1309,new LegsModel(this));
            var_333.add(AvatarEditorCategory.const_549,new WardrobeModel(this));
            var_982 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_333.getValue(AvatarEditorCategory.const_549);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_333.getValue(AvatarEditorCategory.const_549);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_983.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1517.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
                  if(_loc13_.id == _loc12_ && param2 != FigureData.const_54)
                  {
                     _loc11_ = _loc13_;
                  }
               }
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1290.clone() as IWindowContainer,param1,null,null,false);
               _loc6_.iconImage = _loc18_;
               _loc3_.push(_loc6_);
            }
            _loc14_ = param2 != FigureData.const_54;
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1130)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1290.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_333.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_397 == null)
            {
               var_397 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_397.addChild(_view.window);
               var_397.center();
               var_397.visible = false;
            }
            var_397.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_986);
         if(var_170 != null)
         {
            urlString = var_170.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1115 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_656,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_983 = var_1115.getFigureData(AvatarType.HUMAN);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_984 = param3;
         var _loc4_:FigureData = var_661[param2];
         if(_loc4_ == null)
         {
            return;
         }
