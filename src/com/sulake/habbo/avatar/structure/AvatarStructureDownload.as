package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_787:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_1898:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1424 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_1898.append(var_1424);
         dispatchEvent(new Event(AvatarStructureDownload.const_787));
      }
   }
}
