package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_878:CoreComponent;
      
      private var var_32:AssetAliasCollection;
      
      private var var_1012:PaletteManager;
      
      private var var_684:PetDataManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_642 = RenderMode.const_1171;
         if(param1 is CoreComponent)
         {
            var_878 = CoreComponent(param1);
            var_878.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,onComponentsRunning);
         }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_299.getValue(AvatarType.HUMAN) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:AssetLibraryCollection = var_878.assets as AssetLibraryCollection;
         var _loc2_:int = 0;
         ...
         var_684 = new PetDataManager(_loc1_,_loc3_);
         var_1012 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_684.populateFigureData(_loc4_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.HUMAN);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_299.add(AvatarType.HUMAN,_loc5_);
      ...
      {
         return var_684 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_642 = param1;
         if(var_642 == RenderMode.const_1306)
         {
            init();
         }
      }
      ...
      {
         var _loc5_:String = var_684.createAvatarFigureStringNew(param1,param2,param3);
      ...
      {
         var _loc3_:AvatarStructure = var_299.getValue(AvatarType.HUMAN) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_32,param1,param2,AvatarType.HUMAN);
      }
