package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1617 = param2;
         var_571 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_115,onBadgeImageReady);
         ...
         var_190 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1733 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_190);
      ...
      public function dispose() : void
      {
         if(var_571 != null)
         {
            var_571.events.removeEventListener(BadgeImageReadyEvent.const_115,onBadgeImageReady);
            var_571 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_621,var_1733);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_621,var_621));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_621,var_621));
         _localizations.registerParameter(param1,"level",var_1617.toString());
         _localizations.registerParameter(param1,"name",var_571.userName);
         _localizations.registerParameter(param1,"realname",var_571.realName);
      }
   }
}
