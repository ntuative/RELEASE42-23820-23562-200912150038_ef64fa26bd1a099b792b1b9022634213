package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_789:Number = 32;
      ...
      private var var_414:Number = 1;
      
      private var _y:Vector3d;
      
      private var var_1516:Number = 1;
      
      private var var_85:int = 0;
      
      private var var_415:Map = null;
      
      private var var_1031:Vector3d;
      ...
      private var var_1515:Number = 1;
      
      private var var_2255:Number = 500;
      
      private var var_1514:Number = 1;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_89 = new Vector3d();
         var_1031 = new Vector3d();
         var_1516 = 1;
         var_1514 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1515 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_414 != param1 * var_1515)
         {
            var_414 = param1 * var_1515;
            ++var_85;
         }
      }
      ...
      {
         if(var_412 != param1 * var_1516)
         {
            var_412 = param1 * var_1516;
            ++var_85;
         }
      }
      ...
      {
         if(var_413 != param1 * var_1514)
         {
            var_413 = param1 * var_1514;
            ++var_85;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_415 != null)
         {
            ...
            var_415.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_415.add(_loc3_,_loc4_);
            ++var_85;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1031.assign(_loc22_);
         }
         else
         {
            var_1031.assign(_loc17_);
         }
         ++var_85;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_413;
         _loc2_.z *= var_414;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1031);
         if(_loc3_ < var_2254 || _loc3_ > var_2255)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_413;
            _loc2_.z *= var_414;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1031);
         }
      ...
      {
         return new Vector3d(0 * var_412,0 * var_413,0 * var_414);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_415 != null)
         {
            ...
            return var_415.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_194;
         var _loc6_:Number = -param1.y / var_194;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_90,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_412,0 * var_413,0 * var_414);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_89;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_412,param2.y * var_413,param2.z * var_414);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_412,param3.y * var_413,param3.z * var_414);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_412,param4.y * var_413,param4.z * var_414);
