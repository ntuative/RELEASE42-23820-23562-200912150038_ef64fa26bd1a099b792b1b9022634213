package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2278:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_691;
         }
         if(param1 == 2)
         {
            return Tabs.const_590;
         }
         if(param1 == 3)
         {
            return Tabs.const_550;
         }
         if(param1 == 4)
         {
            return Tabs.const_495;
         }
         return Tabs.const_199;
      }
      ...
      private function startSearch() : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_259,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_459 == null)
         {
            var_459 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_459.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
