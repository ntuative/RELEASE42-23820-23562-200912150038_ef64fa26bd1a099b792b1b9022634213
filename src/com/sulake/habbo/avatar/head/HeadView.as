package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_110,param2,param3);
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_130,param2,param3);
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_133,param2,param3);
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_136,param2,param3);
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_147,param2,param3);
         attachImages();
         switchCategory(FigureData.const_110);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_accessories":
                  switchCategory(FigureData.const_133);
                  break;
               case "tab_eyewear":
                  switchCategory(FigureData.const_136);
                  break;
               case "tab_masks":
                  switchCategory(FigureData.const_147);
            }
         }
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1035);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_597[var_1334];
         if(_loc2_ == null)
         {
            return;
         }
