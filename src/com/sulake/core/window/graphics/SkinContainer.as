package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1102:uint = 8;
       
      
      private var var_487:Dictionary;
      
      private var var_2125:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2126 = new Dictionary();
         TypeCodeTable.fillTables(var_1501,var_2126);
         var_1267 = new Dictionary();
         var_2125 = new Dictionary();
         StateCodeTable.fillTables(var_1267,var_2125);
         var_487 = new Dictionary();
         var_487["skin"] = BitmapSkinRenderer;
         var_487["bitmap"] = BitmapDataRenderer;
         var_487["fill"] = FillSkinRenderer;
         var_487["text"] = TextSkinRenderer;
         var_487["shape"] = ShapeSkinRenderer;
         var_487["unknown"] = SkinRenderer;
         var_487["FriendListUpdateEvent"] = NullSkinRenderer;
         if(var_359 == null)
         {
            var_359 = new Array();
            var_359.push(WindowState.const_58);
            var_359.push(WindowState.const_63);
            var_359.push(WindowState.const_83);
            var_359.push(WindowState.const_45);
            var_359.push(WindowState.WINDOW_STATE_HOVERING);
            var_359.push(WindowState.const_71);
            var_359.push(WindowState.const_87);
            var_359.push(WindowState.const_79);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1267)
         {
            _loc3_.push(var_1267[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1501[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_573[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_573[param1] = new Array(SkinContainer.const_1102);
         }
         var_573[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_573[_loc1_]).dispose();
