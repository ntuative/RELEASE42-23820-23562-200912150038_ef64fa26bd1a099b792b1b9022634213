package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1020:IItemGridWindow;
      
      private var _disposed:Boolean = false;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_91:BadgesModel;
      
      private var var_1021:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1021 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_1021.procedure = inactiveGridEventProc;
         var_1020 = _view.findChildByName("active_items") as IItemGridWindow;
         var_1020.procedure = activeGridEventProc;
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "wearBadge_button":
                  _loc3_ = var_91.getSelectedBadge();
                  if(_loc3_ != null)
                  {
                     var_91.toggleBadgeWearing(_loc3_.type);
                  }
            }
         }
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_1020.getGridItemIndex(param1.window);
            _loc4_ = var_91.getBadgeFromActive(_loc3_);
            if(_loc4_ != null)
            {
               var_91.setBadgeSelected(_loc4_.type);
            }
         }
      }
      ...
      private function updateActionView() : void
      {
         ...
         var _loc2_:Badge = var_91.getSelectedBadge();
         if(_loc2_ == null)
         {
            _loc1_.disable();
            setBadgeName(null);
         ...
         else
         {
            ...
            _loc3_ = var_91.getBadges(1);
            if(_loc3_ != null && _loc3_.length >= var_91.getMaxActiveCount() && !_loc2_.isInUse)
            {
               _loc1_.disable();
            }
            else
      ...
      private function updateListViews() : void
      {
         ...
         var_1021.removeGridItems();
         var_1020.removeGridItems();
         var _loc1_:Array = var_91.getBadges(0);
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               var_1021.addGridItem(_loc2_.window);
               _loc2_.window.procedure = inactiveGridEventProc;
            }
            _loc3_++;
         }
         var _loc4_:Array = var_91.getBadges(1);
         _loc3_ = 0;
         while(_loc3_ < _loc4_.length)
         {
            _loc2_ = _loc4_[_loc3_] as Badge;
            var_1020.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_1021.getGridItemIndex(param1.window);
            _loc4_ = var_91.getBadgeFromInactive(_loc3_);
            if(_loc4_ != null)
            {
               var_91.setBadgeSelected(_loc4_.type);
            }
