package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1046:int = 10;
      ...
      private var var_1850:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_144 = param1;
         var_1407 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1850 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_144.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_144.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_719 || param3.type == Message.const_659 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_461.messages.length - const_750);
         _loc1_ = 0;
      ...
      {
         var _loc1_:Conversation = var_144.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_750 + const_1045)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_144.conversations.closeConversation();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_144.send(new FollowFriendMessageComposer(var_461.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_144.getButtonImage(param1);
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_659)
         {
            return 4292801535;
         }
         if(param1 == Message.const_919)
         {
            return 4294927974;
         }
         if(param1 == Message.const_576)
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_144.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_144.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1046;
         param1.invalidate();
      }
   }
}
