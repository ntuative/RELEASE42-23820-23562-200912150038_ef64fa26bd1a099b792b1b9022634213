package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         var _loc4_:Boolean = param1.id == FriendListTab.const_75 && !param1.newMessageArrived;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_287);
         }
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         var_34.width = _friendList.tabs.tabContentWidth;
         var_34.findChildByName("bg").width = _friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in _friendList.tabs.getTabs())
         {
            _loc4_ = var_34.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         var_34.height = _loc2_ + 1;
         var_34.findChildByName("bg").height = var_34.height;
      ...
      {
         if(param1 != FriendListTab.const_100)
         {
            return true;
         }
