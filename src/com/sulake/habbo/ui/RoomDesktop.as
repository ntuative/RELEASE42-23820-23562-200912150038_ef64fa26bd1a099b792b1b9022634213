package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1599:IHabboHelp = null;
      ...
      private var var_730:IRoomWidgetFactory = null;
      ...
      private var var_1115:IAvatarRenderManager = null;
      ...
      private var var_571:ISessionDataManager = null;
      
      private var var_1722:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_426,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_405,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_501,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_619 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_432 != null && true)
         {
            var_1114 = !var_432.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_252[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_426,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_405,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_501,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_33 = null;
         var_730 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1722);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_189 != null)
         {
            var_213.toolbarSize = var_189.size;
            var_213.toolbarOrientation = var_189.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_252[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_730.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_552:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_312,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
            ...
            case RoomEngineObjectEvent.const_440:
               ...
               break;
            case RoomEngineObjectEvent.const_633:
               if(true)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_125:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_530,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_124:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_994,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_534);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_510);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_573);
            _loc15_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_712);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_47 != null)
            {
               ...
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_327);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_438:
               ...
               var_168 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_224,WindowParam.const_77) as IToolTipWindow;
               var_168.setParamFlag(WindowParam.const_44,false);
      ...
      {
         if(var_619 == null || false)
         {
            return;
         }
         var _loc2_:int = var_619.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_619.splice(_loc2_,1);
         }
         if(false)
         {
            var_9 = true;
      ...
      {
         if(var_33 != null && var_47 != null && var_1114 && var_9)
         {
