package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_484:int = 6;
      
      private static const const_339:int = 10;
      
      private static const const_1061:Number = 18;
      
      private static const const_1388:Number = 10;
      
      private static const const_1387:Number = 8;
       
      
      private var var_1199:Number;
      ...
      private var var_200:BitmapData;
      
      private var var_973:uint;
      ...
      {
         _widget.onItemMouseOut(var_972,var_971,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_972,var_971,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1198 = param1.chatType;
         var_972 = param1.userId;
         var_814 = param1.userName;
         var_971 = param1.userCategory;
         _message = param1.text;
         var_1199 = param1.userX;
         var_200 = param1.userImage;
         var_973 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1198)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_98:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_221:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_257:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_200 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_200.height);
         }
         ...
         var_101 = _window as IRegionWindow;
         var_101.background = true;
         var_101.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_101);
         ...
         if(var_200 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_200.width;
               _loc28_.height = var_200.height;
               _loc28_.bitmap = new BitmapData(var_200.width,var_200.height,true,0);
               _loc28_.bitmap.copyPixels(var_200,var_200.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_389 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_200.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_973 != 0)
            {
               _loc31_ = uint(var_973 >> 16 & 255);
               _loc32_ = uint(var_973 >> 8 & 255);
               _loc33_ = uint(var_973 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_339;
            }
            else
            {
               _loc19_.text = var_814 + ":";
               _loc19_.y += var_389;
               _loc19_.width = _loc19_.textWidth + const_339;
               _width += _loc19_.textWidth + const_339;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1198 == RoomWidgetChatUpdateEvent.const_221)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_814);
            }
            else if(var_1198 == RoomWidgetChatUpdateEvent.const_257)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_814);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_389;
            _loc20_.width = _loc20_.textWidth + const_484;
            _width += _loc20_.textWidth + const_484;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_339 + _loc20_.textWidth + const_484;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_972,var_971,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_972,var_971,_roomId,_roomCategory,param1);
      }
