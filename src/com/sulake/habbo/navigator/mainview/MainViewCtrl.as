package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements ICoreUpdateReceiver
   {
      ...
      private var var_1232:IRegionWindow;
      
      private var var_401:int;
      
      private var var_1233:Boolean = true;
      
      private var var_1472:GuestRoomListCtrl;
      ...
      private var var_1470:OfficialRoomListCtrl;
      
      private var var_34:IWindowContainer;
      
      private var var_1471:PopularTagsListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1471 = new PopularTagsListCtrl(_navigator);
         var_1472 = new GuestRoomListCtrl(_navigator);
         var_1470 = new OfficialRoomListCtrl(_navigator);
      ...
      private function prepare() : void
      {
         ...
         var_234 = IWindowContainer(var_28.findChildByName("custom_content"));
         var_201 = IWindowContainer(var_28.findChildByName("list_content"));
         var_266 = IWindowContainer(var_28.findChildByName("custom_footer"));
         var_11 = var_28.findChildByName("loading_text");
         var _loc1_:IWindow = var_28.findChildByTag("close");
         _loc1_.procedure = onWindowClose;
         var_1232 = IRegionWindow(var_28.findChildByName("to_hotel_view"));
         var_1232.procedure = onHotelView;
         ...
         var_28.scaler.setParamFlag(HabboWindowParam.const_504,false);
         var_28.scaler.setParamFlag(HabboWindowParam.const_1224,true);
      }
      ...
      {
         refreshScrollbar(var_1471);
         refreshScrollbar(var_1472);
         refreshScrollbar(var_1470);
      }
      ...
      {
         refreshList(param1,param2,var_1470,"official_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         refreshList(param1,param2,var_1471,"popular_tags");
      }
      
      private function refreshGuestRooms(param1:Boolean, param2:Boolean) : void
      {
         refreshList(param1,param2,var_1472,"guest_rooms");
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = 0;
         Util.moveChildrenToColumn(var_34,["custom_content","list_content"],var_234.y,8);
         var_201.height = var_201.height + _loc1_ - 0 - 0 + var_2061;
         Util.moveChildrenToColumn(var_34,["list_content","custom_footer"],var_201.y,8);
         var_2061 = var_266.height;
         onResizeTimer(null);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_401 == const_760)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_201.blend - _loc2_));
            this.var_201.blend = _loc3_;
            this.var_234.blend = !!var_1233 ? Number(_loc3_) : Number(1);
            this.var_266.blend = !!var_1233 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               var_401 = const_489;
            }
         }
         else if(var_401 == const_489)
         {
            if(var_1234 % 10 == 1)
            {
               var_11.visible = true;
      ...
      {
         _navigator.refreshButton(var_1232,"icon_hotelview",!param1,null,0);
         _navigator.refreshButton(var_1232,"icon_hotelview_reactive",param1,null,0);
      }
