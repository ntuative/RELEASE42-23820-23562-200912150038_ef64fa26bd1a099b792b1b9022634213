package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_998:ITextFieldWindow;
      ...
      {
         super.init();
         var_998 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_998 != null)
         {
            var_998.addEventListener(WindowKeyboardEvent.const_785,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_998.text));
      }
   }
}
