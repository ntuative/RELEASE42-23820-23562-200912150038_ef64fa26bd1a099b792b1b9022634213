package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_309:Dictionary;
      
      protected var var_308:Dictionary;
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_308)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_308[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_309[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_419[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_419[_loc1_]).dispose();
            delete var_419[_loc1_];
         }
         var_419 = null;
         _layoutsByState = null;
         for(_loc1_ in var_309)
         {
            ISkinTemplate(var_309[_loc1_]).dispose();
            delete var_309[_loc1_];
         }
         var_309 = null;
         var_308 = null;
      }
