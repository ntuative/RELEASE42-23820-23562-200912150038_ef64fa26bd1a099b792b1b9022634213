package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_499:Number;
      
      protected var var_1048:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         var_73 = 0;
         param5 |= 0;
         _horizontal = param3 == WindowType.const_288;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12);
         var _loc13_:Rectangle = new Rectangle(0,0,width,height);
         _container = _context.create("_CONTAINER","",WindowType.const_306,WindowStyle.const_224,0 | 0 | 0 | 0,_loc13_,null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_43,containerEventHandler);
         _container.addEventListener(WindowEvent.const_452,containerEventHandler);
      ...
      {
         return new Rectangle(var_499 * maxScrollH,var_497 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_452,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_499 = param1;
            _container.x = -var_499 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("scale_to_fit_items",var_498,PropertyStruct.const_59,var_498 != false));
         _loc1_.push(new PropertyStruct("resize_on_item_update",var_1048,PropertyStruct.const_59,var_1048 != false));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_497 = param1;
            _container.y = -var_497 * maxScrollV;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_70);
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_404,param1);
            }
            else
            {
               _container.setParamFlag(WindowParam.const_469,param1);
            }
         }
      }
