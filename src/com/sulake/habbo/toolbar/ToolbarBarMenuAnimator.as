package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1079:Number = 90;
      
      private static const const_753:int = 50;
      
      private static const const_1059:Number = 25;
      
      private static const const_1060:int = 50;
      
      private static const const_176:Boolean = true;
       
      
      private var var_545:Timer;
      
      private var var_969:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_969 = param2;
         var_545 = new Timer(const_1059);
         var_545.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_468.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_468.splice(_loc3_,1);
            var_467.splice(_loc3_,1);
         }
         var_467.push(param1.name);
         var_468.push(param2);
         param1.addEventListener(WindowEvent.const_350,windowEventListener);
         param1.addEventListener(WindowEvent.const_213,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_468[var_467.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_969.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_294.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_294.splice(var_294.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_969.getIconLoc(param1.iconId);
      ...
      {
         return var_467[var_468.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_294[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_544[_loc3_] = new Array();
            }
            if(var_544[_loc3_].indexOf(param1) < 0)
            {
               var_544[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_753 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_753 || param1.desktop.height - param1.y < const_1060;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_467.length)
         {
            if(var_467[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_544[_loc3_].length)
                  {
                     repositionWindow(var_544[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
