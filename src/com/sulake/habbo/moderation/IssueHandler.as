package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_398:UserInfoCtrl;
      
      private var var_62:ModerationManager;
      
      private var var_986:UserInfoCtrl;
      
      private var var_119:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.releaseBundle(var_119.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc1_:XmlAsset = var_62.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         _window = var_62.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(_window == null)
         {
            return;
         }
         ...
         var_62.disableButton(var_62.initMsg.chatlogsPermission,_window,"show_chatlog");
         _loc2_ = _window.findChildByName("move_to_player_support");
         if(_loc2_ != null)
         {
            _loc2_.disable();
         }
         var _loc3_:IssueMessageData = var_119.getHighestPriorityIssue();
         var_398 = new UserInfoCtrl(_window,var_62,_loc3_.message);
         var_986 = new UserInfoCtrl(_window,var_62,_loc3_.message);
         var_398.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_119.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_986.load(_loc4_,var_119.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_119.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = var_62.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = var_62.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
         var _loc4_:Array = var_119.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_119.getHighestPriorityIssue().issueId;
         var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_62,WindowTracker.const_802,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_62 != null && false && var_119 != null)
         {
            var_62.issueManager.removeHandler(var_119.id);
         }
         this.dispose();
      }
      ...
      {
         if(_window == null || var_62 == null || true)
         {
            return;
         }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_119.getHighestPriorityIssue();
            var_398 = new UserInfoCtrl(_window,var_62,_loc3_.message);
            var_398.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_119.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_119.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = var_62.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = var_62.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return WindowTracker.const_1289;
      }
   }
}
