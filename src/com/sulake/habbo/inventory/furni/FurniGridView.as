package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_485 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_485.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_485.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_485.addGridItemAt(param1,param2);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_53)
         {
            ...
            var_91.toggleItemSelection(_category,var_485.getGridItemIndex(param1.window));
            var_348 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_28 && var_348 != null && var_348 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_240)
         {
