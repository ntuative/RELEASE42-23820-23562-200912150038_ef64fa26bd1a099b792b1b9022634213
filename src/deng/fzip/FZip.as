package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_457 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_627))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_627,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_98 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_627,"EOF"));
            }
         }
      }
      ...
      {
         if(var_457.parse(param1))
         {
            var_53.push(var_457);
            if(false)
            {
               var_135["null"] = var_457;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1321,var_457));
            var_457 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_53 != null && var_135 != null && param1 < var_53.length)
         {
