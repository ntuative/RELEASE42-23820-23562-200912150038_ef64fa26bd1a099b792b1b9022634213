package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1583:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1448:BitmapData;
      
      private const const_1584:int = 13421772;
      
      private var var_823:Rectangle;
      ...
      private var var_552:IFigurePartSet;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_355 = new BitmapData(1,1,true,16777215);
         }
         else
         {
            var_987 = param3.isColorable;
         }
         var_987 = param5;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_355 != null)
            {
               _loc2_ = var_355.clone();
               if(_color != null && var_987)
               {
         ...
         if(var_552 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1448,var_1448.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_823.width,var_823.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_817 + "_" + FigureData.const_263;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_987 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_817 + "_" + FigureData.const_263;
