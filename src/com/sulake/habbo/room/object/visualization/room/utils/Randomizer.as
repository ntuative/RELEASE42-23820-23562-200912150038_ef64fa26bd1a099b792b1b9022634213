package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1409:int = 16777216;
      
      public static const const_1474:int = 1;
       
      
      private var var_2252:int = 69069;
      
      private var var_1209:int = 1;
      
      private var var_2253:int = 5;
      
      private var var_1441:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1441 * param2);
      }
      ...
      {
         var _loc1_:int = var_2252 * var_1209 + var_2253;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
