package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_708:IWindow;
      
      private var var_707:IWindow;
      
      private var var_391:Number;
      
      private var var_706:ITextWindow;
      
      private var var_164:IWidgetAvatarEffect;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_708 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_164.duration);
               var_708.width = _loc2_ * var_391;
            }
            else
            {
               var_708.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_707 = _window.findChildByName("effect_hilite");
            var_707.visible = false;
         }
         var_706 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_708 = _window.findChildByName("loader_bar");
         if(var_708 != null)
         {
            var_391 = var_708.width;
            var_174.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_164.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_706 != null)
         {
            var_706.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_706.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
