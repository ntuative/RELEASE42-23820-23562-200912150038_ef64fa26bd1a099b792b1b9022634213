package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1287:Boolean = true;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1288 = new Timer(100);
         var_1288.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_68 = new Array();
      ...
      {
         return IButtonWindow(var_34.findChildByName("back_button"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_34 = IWindowContainer(_navigator.getXmlWindow("roc_create_room"));
         _list = IItemListWindow(var_34.findChildByName("item_list"));
         refreshRoomThumbnails();
         Util.setProcDirectly(getCreateButton(),onCreateButtonClick);
         Util.setProcDirectly(method_4(),onCancelButtonClick);
         var _loc1_:IWindow = var_34.findChildByTag("close");
         _loc1_.procedure = onCancelButtonClick;
         var_1030 = new TextFieldManager(_navigator,ITextFieldWindow(var_34.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_34.desktop,var_34.width,var_34.height);
         var_34.x = _loc2_.x;
         var_34.y = _loc2_.y;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1030.getText();
      ...
      {
         return IButtonWindow(var_34.findChildByName("create_button"));
      }
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1558 = _navigator.data.hcMember;
      }
      ...
      {
         var_1030.goBackToInitialState();
         var_1030.input.textBackgroundColor = 4294967295;
         var_861 = var_68[0];
         if(var_1558 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_1030.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1287 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1287 = true;
            _loc3_.y = 1;
