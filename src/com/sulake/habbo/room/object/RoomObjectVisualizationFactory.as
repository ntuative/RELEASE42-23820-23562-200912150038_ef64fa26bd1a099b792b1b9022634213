package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_835:IAvatarRenderManager = null;
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_475.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         switch(param2)
         {
            ...
            case RoomObjectVisualizationEnum.PET:
               ...
               break;
            case RoomObjectVisualizationEnum.const_776:
               _loc5_ = FurnitureVisualizationData;
               break;
            case RoomObjectVisualizationEnum.const_861:
            case RoomObjectVisualizationEnum.const_968:
            case RoomObjectVisualizationEnum.const_262:
            case RoomObjectVisualizationEnum.const_864:
            case RoomObjectVisualizationEnum.const_915:
            case RoomObjectVisualizationEnum.const_260:
            case RoomObjectVisualizationEnum.const_894:
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_835;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_835;
            }
            var_475.add(param1,_loc6_);
            return _loc6_;
         }
         return null;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_475 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_475.length)
            {
               _loc1_ = var_475.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_835 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectVisualizationEnum.const_939:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1204:
