package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_342:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1105:uint = 1;
      ...
      private var var_1284:ProfilerAgentTask;
      
      private var var_1283:IEventDispatcher;
      
      private var var_2291:uint = 0;
      
      private var var_1286:ProfilerAgentTask;
      
      private var var_1285:ProfilerOutput;
      
      private var var_700:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_191 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1283 = Component(param1).events;
            var_860 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_700 = new WindowRenderer(_loc4_);
         var_304 = new Array(const_342);
         var _loc6_:int = 0;
         while(_loc6_ < const_342)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_700,this,_localization,var_191,new Rectangle(0,0,var_191.stageWidth,var_191.stageHeight),this);
            var_304[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_397 = var_304[const_1105];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_397.getMouseCursor().defineCustomCursorType(MouseCursorType.const_276,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_397.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1189,_loc7_);
      }
      ...
      {
         return var_304[param1].getDesktopWindow().getChildAt(var_397.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1285 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1285 = new ProfilerOutput(_loc3_,this,var_700);
               var_1284 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1284);
               var_1286 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1286);
               var_1029 = true;
            }
         }
      }
      ...
      {
         return var_397.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_862.length > 0)
         {
            var_1283.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_342 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1283.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_342)
         {
         ...
         if(WindowContext.var_862.length > 0)
         {
            WindowContext.var_862.flush();
         }
         if(WindowContext.var_1291.length > 0)
         {
            WindowContext.var_1291.flush();
         }
         var_1283.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_860[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_860[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_397.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1332,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1353,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1137,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1275,param2.name + ": " + param2.toString());
            }
         }
      }
   }
