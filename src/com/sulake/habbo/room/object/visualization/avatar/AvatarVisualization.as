package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1362:int = 0;
      
      private var var_520:String;
      
      private var var_584:int = 0;
      
      private const const_1568:int = 1;
      
      private var _assetLibrary:AssetLibrary = null;
      
      private var var_1055:Number;
      ...
      private const const_1005:int = 3;
      
      private const const_1569:int = 2;
      
      private var var_718:AvatarVisualizationData = null;
      ...
      {
         var_718 = param1 as AvatarVisualizationData;
         createSprites(const_1004);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_377.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_155);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_649);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_507);
         ...
         var _loc13_:Number = _loc7_ - var_1055;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_294);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_278 != _loc2_.getUpdateID() || var_207 != param1.scale || var_183 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_428 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_428;
            _loc22_ = getTimer();
            if(var_520 != _loc6_)
            {
               for each(_loc48_ in var_377.getKeys())
               {
                  var_377.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               _loc5_ = var_718.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
               var_377.remove(_loc4_);
               var_377.add(_loc4_,_loc5_);
               var_520 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_282);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_264) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc5_.setDirectionAngle(AvatarSetType.const_46,_loc24_);
            _loc5_.initActionAppends();
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_264);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_679);
            _loc5_.appendAction(AvatarAction.const_618,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_470);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_322,AvatarAction.const_1206[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_883);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_807,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_956);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_974);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_832,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_673);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_665);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_793,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_848);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_809,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_432);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_356) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_708);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_424);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_804);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_664,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1569);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_788))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_718.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_278 = _loc2_.getUpdateID();
            var_183 = _loc3_.getUpdateID();
            var_207 = param1.scale;
            var_719.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_719)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_377 != null)
         {
            _loc1_ = var_377.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_377.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
