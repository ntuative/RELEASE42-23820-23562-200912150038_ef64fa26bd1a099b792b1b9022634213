package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_946 != null)
         {
            var_946.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_945 != null)
         {
            var_945.removeEventListener(WindowKeyboardEvent.const_126,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_946 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_946 != null)
         {
            var_946.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_945 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_945 != null)
         {
            var_945.addEventListener(WindowKeyboardEvent.const_126,windowKeyEventProcessor);
         }
      }
