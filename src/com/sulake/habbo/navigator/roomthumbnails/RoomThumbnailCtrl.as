package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1958:IWindowContainer;
      ...
      private var var_91:ThumbnailEditorModel;
      ...
      public function RoomThumbnailCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_91 = new ThumbnailEditorModel();
      }
      
      private function refreshTab() : void
      {
         setEnabled(_bgTabButton,this.var_91.mode != ThumbnailEditorModel.const_37);
         setEnabled(var_1444,this.var_91.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1443,this.var_91.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      {
         this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(_window.findChildByName("picframe")),var_91.data,false);
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(_active)
         {
            var_91.data = _navigator.data.enteredGuestRoom.thumbnail.getCopy();
         }
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in var_91.data.objects)
         {
            if(_loc4_.imgId > 0)
            {
               _loc3_.push(_loc4_);
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(_navigator.data.enteredGuestRoom.flatId,var_91.data.bgImgId,var_91.data.frontImgId,_loc3_.length);
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_51;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1444 = IButtonWindow(find("top_tab"));
         var_1443 = IButtonWindow(find("obj_tab"));
         var_1957 = IWindowContainer(find("tile_grid"));
         var_1958 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1444,onTopTabButton);
         Util.setProcDirectly(var_1443,onObjTabButton);
      }
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = var_91.getImgId();
         var _loc6_:int = 0;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1957;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_352)
            {
         ...
         _loc2_.visible = true;
         refreshTileLoc(_loc2_,var_91.selected.pos);
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_31;
         this.reload();
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = var_1958;
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Dictionary = var_91.getBlockedPositions();
         while(_loc3_ <= RoomThumbnailRenderer.const_352)
         {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),onImgSel,_loc10_.id));
