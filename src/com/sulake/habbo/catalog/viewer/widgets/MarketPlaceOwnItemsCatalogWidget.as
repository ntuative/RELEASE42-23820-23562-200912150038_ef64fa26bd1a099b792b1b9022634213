package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private function updateList(param1:Map) : void
      {
         ...
         updateStatusDisplay(const_1360,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc9_ = _loc6_[_loc7_];
            _loc10_ = param1.getValue(_loc9_) as MarketPlaceOfferData;
            if(_loc10_.status == MarketPlaceOfferState.const_428)
            {
               _loc5_ = true;
            }
            ...
            if(_loc4_)
            {
               ...
               if(_loc10_.status == MarketPlaceOfferState.const_990)
               {
               ...
               if(_loc10_.status == MarketPlaceOfferState.const_981)
               {
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_990,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_428,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_981,_loc2_);
            }
         }
