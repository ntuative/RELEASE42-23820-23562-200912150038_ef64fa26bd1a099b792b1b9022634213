package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1019:int = 0;
      
      private static const const_333:int = 1;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_618 == null || _loc3_ < 0 || _loc3_ >= var_618.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_618[_loc3_];
            main.showUI(HabboHelpViewEnum.const_513);
            main.tellUI(HabboHelpViewEnum.const_513,null);
         }
      }
   }
}
