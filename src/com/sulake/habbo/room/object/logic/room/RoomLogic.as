package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1345:int = 1500;
      
      private var var_1344:int = 255;
      
      private var var_1343:int = 255;
      
      private var var_1075:uint = 16777215;
      
      private var var_889:uint = 16777215;
      
      protected var var_84:RoomPlaneParser = null;
      
      private var var_734:int = 0;
      
      private var var_1280:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_540:
                  _loc2_.setString(RoomObjectVariableEnum.const_496,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_558:
                  _loc2_.setString(RoomObjectVariableEnum.const_542,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_563:
                  _loc2_.setString(RoomObjectVariableEnum.const_703,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_427:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_189)
                  {
                     _loc8_ = "null";
                  }
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_927,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_977,int(_loc5_.bgOnly));
            var_1075 = _color;
            var_1344 = var_1280;
            var_889 = _loc11_;
            var_1343 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_645,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1218,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1192,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1190,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_137)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_146 || _loc13_ == RoomPlaneData.const_255)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_734)
         {
            ...
            {
               _loc6_ = var_1075 >> 16 & 255;
               _loc7_ = var_1075 >> 8 & 255;
               _loc8_ = var_1075 & 255;
               _loc9_ = var_889 >> 16 & 255;
               _loc10_ = var_889 >> 8 & 255;
               _loc11_ = var_889 & 255;
               _loc12_ = (_loc1_ - var_734) / var_1345;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1344 + (var_1343 - var_1344) * _loc12_;
               _color = _loc2_;
               var_1280 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_645,_loc2_);
         }
      }
   }
}
