package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1036:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_725,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_106,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_103,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_725,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_106,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_103,onDoorbellHandled);
      }
