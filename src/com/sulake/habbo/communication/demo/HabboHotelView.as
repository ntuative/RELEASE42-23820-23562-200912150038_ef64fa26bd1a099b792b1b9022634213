package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_785:uint = 0;
      
      private var var_634:IAssetLibrary;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_634.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_634.getAssetByName(_loc2_.assetName);
         if(param1.type == AssetLoaderEvent.const_47)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_56));
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_634.loadAssetFromFile("hotel_view_banner_" + var_785,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_658));
            }
            var_186 = param2;
