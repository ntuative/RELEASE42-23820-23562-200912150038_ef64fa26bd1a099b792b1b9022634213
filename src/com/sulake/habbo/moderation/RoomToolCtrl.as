package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_887:ICheckBoxWindow;
      ...
      private var var_600:ICheckBoxWindow;
      
      private var var_58:IFrameWindow;
      
      private var var_888:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_55,WindowTracker.const_677,_data.flatId),var_58,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_405);
         if(param1.flatId != var_405)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_405);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_600.isSelected);
         var_55.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1228,_loc2_,var_379.text,"",""));
         if(false)
         {
            var_55.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_887.isSelected,var_888.isSelected,var_600.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1350);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1264);
      }
      ...
      public function populate() : void
      {
         ...
         var_600 = ICheckBoxWindow(var_58.findChildByName("kick_check"));
         var_887 = ICheckBoxWindow(var_58.findChildByName("lock_check"));
         var_888 = ICheckBoxWindow(var_58.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_55.connection.send(new GetModeratorRoomInfoMessageComposer(var_405));
         Logger.log("BEGINNING TO SHOW: " + var_405);
      }
   }
}
