package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_73,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_688,RoomWidgetEcotronBoxOpenMessage.const_516,RoomWidgetEcotronBoxOpenedMessage.const_1117];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_237:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_73,0,_name,false,_loc3_.data);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_688:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_516:
