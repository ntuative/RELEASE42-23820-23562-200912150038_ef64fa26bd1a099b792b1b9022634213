package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1002:int = 100;
      
      public static const const_320:String = "pets";
      ...
      private var var_591:IWindowContainer;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_200,onObjectPlaced);
         var_427 = new Timer(const_1002,1);
         var_427.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_226;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_361.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_361.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_581)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_200,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_427 != null)
            {
               var_427.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_427.stop();
               var_427 = null;
            }
            if(var_124 != null)
            {
               var_124.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_124.stop();
               var_124 = null;
            }
            if(var_591 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_169)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(param3 == FurniCategory.const_313)
         {
         ...
         else if(param3 == FurniCategory.const_275)
         {
         ...
         if(var_591 == null)
         {
            var_591 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_591.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_226:
               ...
               break;
            case InventorySubCategory.const_941:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_124 = new Timer(param1,1);
            var_124.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_124.start();
         }
         else
         {
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_460);
      ...
      {
         if(param1 == InventoryCategory.const_68 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_320:
                  _controller.toggleInventoryPage(InventoryCategory.const_165);
            }
         }
      }
      ...
      {
         if(var_714 && param1.type == RoomEngineObjectEvent.const_200)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_325 || _loc3_.category == FurniCategory.const_313 || _loc3_.category == FurniCategory.const_275)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_361.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_361 = new Map();
         var_361.add(const_41,new Array());
         var_361.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
