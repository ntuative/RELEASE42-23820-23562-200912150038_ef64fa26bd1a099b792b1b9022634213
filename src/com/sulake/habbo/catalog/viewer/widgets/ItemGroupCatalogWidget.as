package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_560[var_999] as Array;
      ...
      {
         var _loc2_:Offer = var_560[var_999][var_2062];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_390 || _loc1_.pricingModel == Offer.const_464)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_81 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1000.indexOf(_loc5_) == -1)
                        {
                           var_1000.push(_loc5_);
                           var_560.push(new Array());
                        }
                        _loc6_ = var_1000.indexOf(_loc5_);
                        (var_560[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_560)
         {
            if(var_2062 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2062] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_999 = var_869.getGridItemIndex(param1.view);
