package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_998:Number = 100;
      
      private static const const_999:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_73,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_364,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_415,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_429,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_417,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_73,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_364,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_415,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_429,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_417,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_61:
               hideInterface();
               var_211 = false;
               var_150 = param1.objectId;
               var_190 = param1.text;
               _controller = param1.controller;
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_415:
               if(!var_211)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_429:
               if(!var_211)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_417:
               if(!var_211)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_364:
               if(!var_211)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(var_211 || var_150 == -1 || !_controller)
         {
            return;
         }
         var_211 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_592,var_150);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_998,const_999,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_190 != null)
         {
            _loc4_.caption = var_190;
         }
