package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_587:FaqCategory;
      
      private var var_588:FaqCategory;
      ...
      {
         super();
         var_588 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_587 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_123 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_588.hasItem(param1))
         {
            var_588.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_587.hasItem(param1))
         {
            var_587.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
