package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      protected var var_580:Function;
      ...
      protected var var_495:uint;
      
      protected var var_29:IGraphicContext;
      
      protected var var_307:Boolean;
      ...
      public function WindowController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         if(!var_29)
         {
            var_29 = getGraphicContext(!testParamFlag(WindowParam.const_33));
         }
         var_873 = false;
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         var _loc11_:Boolean = param1.getParamFlag(WindowParam.const_57);
         if(param2)
         {
            _loc3_ = 0;
         ...
         if(_loc9_)
         {
            if(_loc11_)
            {
               param1.setParamFlag(WindowParam.const_57,false);
            }
            if(param2)
            {
               _loc3_ = 0;
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_77);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_77,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_77,true);
                  }
                  _loc3_++;
               }
            }
            ...
            if(_loc11_)
            {
               param1.setParamFlag(WindowParam.const_57,true);
            }
         }
      }
      ...
      public static function expandToAccommodateChild(param1:WindowController, param2:IWindow) : void
      {
         ...
         if(_loc8_)
         {
            _loc9_ = param1.getParamFlag(WindowParam.const_57);
            param1.setParamFlag(WindowParam.const_57,false);
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_112,WindowParam.const_149);
         var _loc2_:* = !testParamFlag(WindowParam.const_111,WindowParam.const_148);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_30 & 0);
               if(_loc5_ == WindowParam.const_246)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_283)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_151)
               {
         ...
         else if(testParamFlag(WindowParam.const_77))
         {
            _loc3_ = var_22.clone();
            if(var_23 != null)
            {
      ...
      {
         var_5 = param1;
         var_422 = !!var_5 ? uint(var_422 | _alphaColor) : uint(var_422 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_70);
      }
      
      public function destroy() : Boolean
      {
         if(_state == WindowState.const_422)
         {
            return true;
         }
         _state = WindowState.const_422;
      ...
      public function setupGraphicsContext() : IGraphicContext
      {
         ...
         if(numChildren > 0)
         {
            if(var_29.numChildContexts != numChildren)
            {
               _loc1_ = uint(numChildren);
               _loc2_ = 0;
               while(_loc2_ < _loc1_)
               {
                  var_29.addChildContextAt(WindowController(getChildAt(_loc2_)).getGraphicContext(true),_loc2_);
                  _loc2_++;
               }
            }
         }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1806 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            case WindowNotifyEvent.const_528:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_812:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1125:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1219:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_866:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_414:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_304:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_959:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_794:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_965:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_774:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_386:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_717:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_779:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_229:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_996:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_625:
               _loc2_ = "null";
               break;
      ...
      public function swapChildrenAt(param1:int, param2:int) : void
      {
         ...
         var_29.swapChildContextsAt(param1,param2);
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         setStateFlag(WindowState.const_87,false);
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_821,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_29)
         {
            var_29 = new GraphicContext("GC {" + _name + "}",GraphicContext.GC_TYPE_BITMAP,var_22);
            var_29.visible = var_342;
         }
         return var_29;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_22,WindowRedrawFlag.const_901);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_939 || _loc3_.hasGraphicsContext())
         {
            setupGraphicsContext();
            if(_loc3_.getGraphicContext(true).parent != var_29)
            {
               var_29.addChildContextAt(_loc3_.getGraphicContext(true),param2);
            }
         }
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_310,this,param1));
         return param1;
      }
      ...
      public function swapChildren(param1:IWindow, param2:IWindow) : void
      {
         ...
         {
            var_29.swapChildContexts(WindowController(param1).getGraphicContext(true),WindowController(param2).getGraphicContext(true));
         }
      }
      
      public function hasGraphicsContext() : Boolean
      {
         return !testParamFlag(WindowParam.const_33) || var_29 != null;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_495);
      }
      
      public function set color(param1:uint) : void
      {
         _alphaColor = param1 & 4278190080;
         var_422 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_70);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_630))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_958;
                  if(testParamFlag(WindowParam.const_286))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                  ...
                  if((var_30 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_230))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_230))
                  {
               ...
               case MouseEvent.MOUSE_OUT:
                  ...
                  {
                     setStateFlag(WindowState.WINDOW_STATE_HOVERING,false);
                  }
                  break;
               case MouseEvent.MOUSE_OVER:
                  if(!testStateFlag(WindowState.WINDOW_STATE_HOVERING))
                  {
                     setStateFlag(WindowState.WINDOW_STATE_HOVERING,true);
                  }
                  break;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_254:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_430,this,null));
                     if(testParamFlag(WindowParam.const_157,WindowParam.const_149))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_151,WindowParam.const_148))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        _loc8_ = uint(var_30);
                        var_30 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_404))
                        {
                           var_23.width += 0 - 0;
                        }
                  ...
                  break;
               case WindowNotifyEvent.const_385:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_351);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_779,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_229,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_315:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_717,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_203,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_391:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_946);
                  break;
               case WindowNotifyEvent.const_379:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_386:
                  if(!(var_30 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_351);
                     }
                  }
                  else if(var_30 & 0)
                  {
               ...
               case WindowNotifyEvent.const_430:
                  ...
                  break;
               case WindowNotifyEvent.const_310:
                  if(testParamFlag(WindowParam.const_57))
                  {
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_957,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         return var_580 != null ? var_580 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_959,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,true);
         _loc1_.type = WindowNotifyEvent.const_794;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_495);
      }
      ...
      public function activate() : Boolean
      {
         ...
         setStateFlag(WindowState.const_87,true);
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            {
               var_29.removeChildContext(_loc2_.getGraphicContext(true));
            }
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_625,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_798,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_531;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_939 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
            if(_loc2_.getGraphicContext(true).parent != var_29)
            {
               var_29.addChildContext(_loc2_.getGraphicContext(true));
            }
         }
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_310,this,param1));
         return param1;
      ...
      public function setChildIndex(param1:IWindow, param2:int) : void
      {
         ...
         {
            var_29.setChildContextIndex(_loc3_.getGraphicContext(true),getChildIndex(_loc3_));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_467)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_30 & 0);
            if(_loc7_ == WindowParam.const_463)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_401)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_77))
         {
            if(var_23 != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_865,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_528,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_254,this,null));
            }
         }
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_391,this,null));
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1162,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,true);
         _loc1_.type = WindowNotifyEvent.const_1159;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_307 && var_495 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1396,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1396,param3,param1)) : false;
            }
         }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc9_:Boolean = getParamFlag(WindowParam.const_57);
         _loc1_ = 0;
         while(_loc1_ < _loc8_)
         {
         ...
         if(_loc7_)
         {
            if(_loc9_)
            {
               setParamFlag(WindowParam.const_57,false);
            }
            ...
            if(_loc9_)
            {
               setParamFlag(WindowParam.const_57,true);
            }
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               ...
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_457,this,var_23));
            }
            else
            {
               var_289.x = 0;
               ...
               var_289.width = 0;
               var_289.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_996,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_241,_type,var_86,var_30,_context,var_22,null,var_580,properties,var_583.concat(),_id) as WindowController;
         _loc2_.var_495 = var_495;
         _loc2_.var_307 = var_307;
         _loc2_.var_873 = var_873;
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1288,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,false);
         _loc1_.type = WindowNotifyEvent.const_1300;
         update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_497;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_560;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_495 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_774,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
