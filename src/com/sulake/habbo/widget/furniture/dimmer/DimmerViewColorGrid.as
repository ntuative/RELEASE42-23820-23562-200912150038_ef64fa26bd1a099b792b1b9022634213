package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_465:BitmapData;
      
      private var var_1186:XML;
      
      private var var_285:IWindowContainer;
      
      private var var_386:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            _loc3_.width = var_465.width;
            _loc3_.height = var_465.height;
            var_386.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_465.width,var_465.height,true,0);
               _loc4_.bitmap.copyPixels(var_465,var_465.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_805.width,var_805.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_650.width,var_650.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_650,var_650.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_386.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_386.numGridItems)
         {
            return;
         }
         select(var_386.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_285 != null)
         {
            _loc2_ = var_285.getChildByName("chosen");
            if(_loc2_ != null)
            {
