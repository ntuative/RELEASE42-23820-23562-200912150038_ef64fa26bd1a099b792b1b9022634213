package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_970:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_311 && _connection != null)
         {
            _state = RoomSessionEvent.const_86;
            if(isPrivateRoom)
            {
      ...
      {
         return var_970 as IUserDataManager;
      }
