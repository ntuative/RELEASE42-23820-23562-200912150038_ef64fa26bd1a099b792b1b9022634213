package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_39:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_25 = param1;
         var_39 = var_25.communication;
         var_39.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_39.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_39.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_39.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_39.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_39.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_39.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_39.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_39.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_39.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_39.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_39.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_39.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_39.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_39.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_39.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_39.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_39.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_39.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_39.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_39.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_39.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_39.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_39.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_39.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_39.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_39.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_39.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_39.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_39.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_39.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_39.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_39.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_39.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_39.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_39.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_68,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_578);
         _loc2_.refreshViews();
         var_25.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_169)
            {
            ...
            if(_loc9_.itemType == "S")
            {
               ...
               _loc6_.push(new FloorItem(_loc9_.itemID,_loc9_.itemTypeID,_loc9_.roomItemID,_loc9_.category,true,true,true,true,_loc9_.itemSpecificData,_loc9_.timeToExpiration,_loc9_.creationDay,_loc9_.creationMonth,_loc9_.creationYear,null,_loc9_.songID));
            }
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_42,_loc9_.category,_loc9_.itemSpecificData);
                  _loc3_.add(_loc8_,_loc6_);
               }
               _loc6_.push(new WallItem(_loc9_.itemID,_loc9_.itemTypeID,_loc9_.roomItemID,_loc9_.category,true,true,true,true,_loc9_.itemSpecificData));
            }
            _loc10_++;
         }
         ...
         if(_loc12_ != null)
         {
            _loc12_.updateItemGroupMaps(_loc2_.firstUserID,_loc3_,_loc2_.method_3,_loc4_);
         }
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_39.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_165);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_25.setInventoryCategoryInit(InventoryCategory.const_292);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_68);
         ...
         while(_loc12_ < _loc3_.length)
         {
            ...
            if(_loc9_.indexOf(_loc6_.stripId) == -1)
            {
               ...
               {
                  _loc5_ = new FloorItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData,_loc6_.expiryTime,0,0,0,_loc6_.slotId,_loc6_.songId);
               }
               else
               {
                  ...
                  _loc5_ = new WallItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData);
               }
               if(_loc7_.length == 0)
               {
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_25.toggleInventorySubPage(InventorySubCategory.const_226);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_25.setInventoryCategoryInit(InventoryCategory.const_242);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_460);
         var _loc4_:FurniModel = var_25.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
