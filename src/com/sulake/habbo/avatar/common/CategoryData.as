package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_701 > -1)
         {
            return var_351[var_701] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_701 >= 0)
         {
            _loc3_ = var_351[var_701];
            _loc3_.isSelected = false;
         }
         if(var_351.length > param1)
         {
            _loc2_ = var_351[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_701 = param1;
      ...
      public function selectColourWithId(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_351.length)
         {
            _loc3_ = var_351[_loc2_];
