package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2166:uint = 0;
      
      protected var var_864:String = "";
      
      protected var var_416:Array;
      
      protected var var_865:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         param5 |= 0;
         var_416 = new Array();
         var_416[0] = MouseCursorType.const_276;
         var_416[1] = MouseCursorType.const_39;
         var_416[2] = MouseCursorType.const_276;
         var_416[3] = MouseCursorType.const_276;
         var_416[4] = MouseCursorType.const_39;
         var_416[5] = MouseCursorType.const_39;
         var_416[6] = MouseCursorType.const_276;
         if(var_311 == null)
         {
            var_311 = new Array();
            var_311[0] = WindowState.const_87;
            var_311[1] = WindowState.const_71;
            var_311[2] = WindowState.WINDOW_STATE_HOVERING;
            var_311[3] = WindowState.const_58;
            var_311[4] = WindowState.const_45;
            var_311[5] = WindowState.const_83;
         ...
         while(_loc5_ < _loc3_)
         {
            ...
            switch(_loc4_.key)
            {
               ...
               case "mouse_cursor_hovering":
                  param1.setMouseCursorByState(WindowState.WINDOW_STATE_HOVERING,_loc4_.value as uint);
                  break;
               case "mouse_cursor_pressed":
                  param1.setMouseCursorByState(WindowState.const_83,_loc4_.value as uint);
                  break;
