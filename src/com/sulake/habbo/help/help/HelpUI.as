package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1374:int = 0;
      ...
      private var var_1676:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23820-23562-200912150010");
         var_189 = param5;
         var_105 = new Map();
         var_105.add(HabboHelpViewEnum.const_1337,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_132,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_443,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_222,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_184,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_586,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_293,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_513,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_202,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         var_105.add(HabboHelpViewEnum.CALL_FOR_HELP_HAS_ABUSIVE_ITEM,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_abusive")));
         var_105.add(HabboHelpViewEnum.const_871,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_686,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_248 == HabboHelpViewEnum.const_132 || false)
         {
            return;
         }
         if(var_368 == null)
      ...
      {
         return var_105.getValue(var_248);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_105.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_105.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1675 = param1;
         var _loc2_:IHelpViewController = var_105.getValue(HabboHelpViewEnum.const_132) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_202:
               ...
               break;
            case CallForHelpResultEnum.const_782:
               showUI(HabboHelpViewEnum.const_871);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_248 == HabboHelpViewEnum.const_132)
         {
            return;
         }
         if(true)
         {
            ...
            var_513.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_513[1],var_513[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_513[0],var_513[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1364;
         _window.width = _loc1_.width + var_1363;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_105.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_189 != null)
            {
               var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_42.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_556));
      }
