package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1012:Number = 30;
      ...
      {
         var_601 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1088 = param3;
         var_1602 = param4 * 0 * 2 / 360;
         var_1342 = param5 * 0 * 2 / 360;
         _height = param6;
         var_732 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1088 * Math.cos(var_732 + var_1342);
         var _loc4_:Number = var_1088 * Math.sin(var_732 + var_1342);
         var _loc5_:Number = _height;
         var_601.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_601.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_601.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_601.add(param1);
         }
