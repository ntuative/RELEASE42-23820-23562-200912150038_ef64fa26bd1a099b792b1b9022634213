package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      {
         var _loc2_:Object = var_134[param1];
         if(_loc2_ == null)
         {
            return null;
         }
         var _loc3_:int = var_40.indexOf(_loc2_);
         if(_loc3_ >= 0)
         {
            var_40.splice(_loc3_,1);
            var_221.splice(_loc3_,1);
            --_length;
         }
         delete var_134[param1];
         return _loc2_;
      }
      ...
      public function unshift(param1:*, param2:*) : Boolean
      {
         ...
         var_134[param1] = param2;
         var_40.unshift(param2);
         var_221.unshift(param1);
         ++_length;
         return true;
      }
      ...
      override flash_proxy function getProperty(param1:*) : *
      {
         ...
         return var_134[param1];
      }
      
      public function reset() : void
      {
         var _loc1_:* = null;
         for(_loc1_ in var_134)
         {
            delete var_134[_loc1_];
         }
         _length = 0;
         var_40 = [];
         var_221 = [];
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         var_134[param1] = param2;
         var _loc3_:int = var_221.indexOf(param1);
         if(_loc3_ == -1)
         {
            var_40[_length] = param2;
            var_221[_length] = param1;
            ++_length;
         }
         else
         {
            var_40.splice(_loc3_,1,param2);
         }
      }
