package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1048:String = "increment";
      
      private static const const_483:String = "slider_bar";
      
      private static const const_1047:String = "decrement";
      
      private static const const_751:String = "slider_track";
      ...
      protected var var_1522:Number = 0.1;
      
      private var var_794:String;
      ...
      public function ScrollbarController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0, param13:IScrollableWindow = null)
      {
         ...
         var_35 = param13;
         _horizontal = param3 == WindowType.const_466;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.name)
            {
               case ScrollbarController.const_483:
                  if(param2.type == WindowNotifyEvent.const_229)
                  {
                     if(!var_538)
                     {
                        if(_horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_457)
         {
            if(var_35 == null)
            {
               resolveScrollTarget();
      ...
      {
         return getChildByName(ScrollbarController.const_751) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_35 != null && true)
         {
            IWindow(var_35).removeEventListener(WindowEvent.const_43,onScrollableResized);
         }
         var_35 = param1;
         if(var_35 != null && true)
         {
            IWindow(var_35).addEventListener(WindowEvent.const_43,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.getChildByName(ScrollbarController.const_483) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_794 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_794 != null)
         {
            _loc1_ = findParentByName(var_794) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_794) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1048)
            {
               if(var_35)
               {
                  var_538 = true;
            ...
            else if(param2.name == ScrollbarController.const_1047)
            {
               if(var_35)
               {
                  var_538 = true;
            ...
            else if(param2.name == ScrollbarController.const_751)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_483).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_978)
         {
