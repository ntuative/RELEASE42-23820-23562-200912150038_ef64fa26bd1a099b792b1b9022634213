package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1575:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1576:String = "level";
      
      private var var_110:IItemListWindow;
      
      private const const_1578:String = "energy";
      
      private var var_1080:Map;
      
      private const const_1577:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1573:uint = 3355443;
      
      private var var_219:IBorderWindow;
      
      private const const_1572:int = 158;
      
      private const const_1571:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_244:PetCommandTool;
      
      private const const_1570:uint = 11184810;
      
      private const const_1574:String = "experience";
      ...
      private function openTrainView() : void
      {
         if(var_244 == null)
         {
            var_244 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1080.getValue(var_653) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_244.showWindow(true);
            var_244.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1576,param1.level,param1.levelMax);
         updateStateElement(const_1574,param1.experience,param1.experienceMax);
         updateStateElement(const_1578,param1.energy,param1.energyMax);
         updateStateElement(const_1577,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_653 = param1.id;
         var_1080.remove(param1.id);
         var_1080.add(param1.id,param1);
         if(var_244 && var_244.isVisible() && param1.isOwnPet)
         {
            var_244.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_244.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_368,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1572,const_1571,false);
