package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_736:String = "selection_arrow";
      
      private static const const_735:String = "tile_cursor";
      ...
      private static const const_332:String = "place_holder";
      
      private static const const_1017:String = const_332;
      
      private static const const_1369:int = 0;
      
      private static const const_737:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_669:String = "RCL_LOADER_READY";
      ...
      private var var_892:IEventDispatcher = null;
      
      private var _publicRooms:Map = null;
      
      private var var_435:Map = null;
      
      private var var_510:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_604 = [];
         var_603 = [];
         var_1628 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1631 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_367 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_510.getValue(param1) as String;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_366 != null)
         {
            _loc2_ = var_366.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(var_165 != null && var_165.hasWorldType(const_270 + param1))
         {
            return var_165.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_604.indexOf(_loc14_) < 0)
                              {
                                 var_604.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_510.add(_loc10_,_loc11_);
                              if(var_603.indexOf(_loc14_) < 0)
                              {
                                 var_603.push(_loc14_);
                              }
                           }
                           _loc16_ = var_435.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_435.remove(_loc14_);
                              var_435.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_367 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_367.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_314 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_314.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_332,const_480,ROOM_CONTENT,const_735,const_736];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_367.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_509.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_367.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_32 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_435.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1628.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_171 && _loc5_ != RoomObjectLogicEnum.const_107)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_604.indexOf(param1) >= 0)
         {
            return const_332;
         }
         if(var_603.indexOf(param1) >= 0)
         {
            return const_480;
         }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_365 != null)
         {
            _loc2_ = var_365.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1116);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_510.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1631.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_426,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_405,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_250;
         }
         return RoomObjectCategoryEnum.const_205;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1629)
         {
            ...
            if(var_892 != null)
            {
               var_892.dispatchEvent(new Event(const_669));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_165 != null)
         {
            return var_165.getWorldHeightScale(const_270 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_892 = param1;
            var_1634 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1630 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1633 = param2.getKey("public.room.dynamic.download.url","");
            var_1632 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_737;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_314.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_365 != null)
         {
            var_365.remove(param1);
            var_365.add(param1,param2);
         }
         if(var_366 != null)
         {
            var_366.remove(param2);
            var_366.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_171 && _loc5_ != RoomObjectVisualizationEnum.const_107)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_360.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_314.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(getObjectCategory(const_270 + param1) == RoomObjectCategoryEnum.const_60)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_165 = _publicRooms.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_446,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_165 != null)
         {
            return var_165.getWorldScale(const_270 + param1);
         }
         return 32;
      }
