package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_565:String = "Rectangle";
      
      public static const const_59:String = "Boolean";
      
      public static const const_715:String = "Number";
      
      public static const const_85:String = "int";
      
      public static const const_214:String = "String";
      
      public static const const_631:String = "Point";
      
      public static const const_837:String = "Array";
      
      public static const const_1183:String = "uint";
      
      public static const const_369:String = "hex";
      
      public static const const_827:String = "Map";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean)
      {
         ...
         _type = param3;
         var_1845 = param4;
         var_2213 = param3 == const_827 || param3 == const_837 || param3 == const_631 || param3 == const_565;
      }
      ...
      public function toString() : String
      {
         switch(_type)
         {
            ...
            case const_59:
               return Boolean(var_175) == true ? "HabboAvatarRenderLib_fx15" : "false";
            case const_631:
      ...
      public function toXMLString() : String
      {
         ...
         switch(_type)
         {
            case const_827:
               ...
               _loc1_ = "<var key=\"" + var_537 + "\">\r<value>\r<" + _type + ">\r";
               _loc2_ = 0;
            ...
            case const_565:
               ...
               break;
            case const_369:
               _loc1_ = "<var key=\"" + var_537 + "\" value=\"" + "0x" + uint(var_175).toString(16) + "\" type=\"" + _type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + var_537 + "\" value=\"" + var_175 + "\" type=\"" + _type + "\" />";
         }
         return _loc1_;
      }
