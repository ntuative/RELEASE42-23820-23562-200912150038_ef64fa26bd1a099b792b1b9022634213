package
{
   ...
   public class HabboMain extends Sprite implements IHabboMain
   {
      ...
      private var var_1526:ICoreConfigStatusListener;
      ...
      public function initializeCore() : void
      {
         ...
         {
            Core.crash("Failed to initialize the core: " + error.message,CoreComponent.const_1209,error);
         }
      }
      ...
      {
         initCore("config_habbo.xml",Core.const_991);
      }
      ...
      private function initCore(param1:String, param2:uint) : void
      {
         ...
         var_878.loadExternalConfigDocument(new URLRequest(param1),var_1526);
      }
   }
}
