package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1354:String = "ctlg_";
       
      
      private var _localization:IPageLocalization;
      
      protected var var_1292:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_728:String;
      
      private var var_1068:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_762:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_728);
      }
      ...
      {
         var _loc2_:String = const_1354 + param1;
         ...
         var_1292 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1292) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1127) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1140) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1068;
            _loc2_.init();
         }
         var_1068.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1068.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_728);
      }
