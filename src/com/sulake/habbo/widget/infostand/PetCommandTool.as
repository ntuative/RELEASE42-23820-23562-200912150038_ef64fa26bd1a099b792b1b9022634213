package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_926 = new Map();
         var_332 = new Timer(const_1592);
         var_332.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_613,param1);
      ...
      {
         var_926.remove(param1);
         var_926.add(param1,param2);
         if(param1 != var_653)
         {
            return;
         }
      ...
      {
         var _loc2_:Array = var_926.getValue(var_653) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_358,var_653));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_606,var_653,var_1941 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_926.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_653);
         }
         else
         {
      ...
      private function createCommandWindow() : void
      {
         ...
         var_48.setParamFlag(WindowParam.const_77,true);
