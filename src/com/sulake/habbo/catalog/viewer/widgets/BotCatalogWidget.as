package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_285:IGridItem;
      
      protected var var_869:IItemGridWindow;
      
      protected var var_1294:XML;
      
      private var var_1369:Map;
      
      private var var_755:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_869 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var_869.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1369.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_101);
      ...
      {
         var _loc1_:String = var_1369.getValue(var_755.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_755,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_755.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_755.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_755.localizationId);
