package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_705:Boolean;
      
      protected var var_149:Rectangle;
      
      protected var var_422:uint;
      
      protected var _state:uint;
      
      protected var var_86:uint;
      
      protected var var_342:Boolean;
      
      protected var var_241:String;
      ...
      public function WindowModel(param1:uint, param2:String, param3:String, param4:uint, param5:uint, param6:uint, param7:WindowContext, param8:Rectangle, param9:Array = null)
      {
         ...
         var_86 = param5;
         var_583 = param9 == null ? new Array() : param9;
         var_241 = param3;
         _context = param7;
         var_22 = param8.clone();
         var_357 = param8.clone();
         var_60 = param8.clone();
