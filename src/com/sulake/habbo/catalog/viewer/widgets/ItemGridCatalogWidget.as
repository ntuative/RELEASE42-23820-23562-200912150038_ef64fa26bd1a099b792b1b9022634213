package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_285:IGridItem;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_753 >= 0 && var_753 < page.offers.length)
            {
               _loc4_ = page.offers[var_753];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_361)
         {
            ++var_1366;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1366);
         }
      }
      
      override public function init() : void
      {
         var_869 = _window.findChildByName("itemGrid") as IItemGridWindow;
