package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_906:MarketplaceModel;
      
      private var var_440:Map;
      
      private var var_441:String;
      
      private const const_1596:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_440 = new Map();
         var_440.add(FurniModel.const_41,new FurniGridView(var_91,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_440.add(FurniModel.const_42,new FurniGridView(var_91,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "offertotrade_btn":
                  ...
                  break;
               case "sell_btn":
                  var_91.requestSelectedFurniSelling();
                  break;
               default:
         ...
         else if(param1.type == WindowEvent.const_52)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_320);
            }
         }
      }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_440.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_440.getValue(var_441);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_41,FurniModel.const_42];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = var_440.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = var_91.getGroupItemInIndex(_loc3_,var_441);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_313)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_325)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_275)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_906 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_440.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
