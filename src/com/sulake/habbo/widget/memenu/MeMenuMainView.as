   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         while(_loc5_ < _window.numChildren)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_28,onMouseOverOrOut);
            _loc5_++;
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_963);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_840));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_519);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_890));
               _widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_661));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_502);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","false") == "HabboAvatarRenderLib_fx15";
               if(false && _loc4_)
               {
               ...
               else
               {
                  ...
                  HabboWebTools.openWebPage(_loc5_,"habboMain");
