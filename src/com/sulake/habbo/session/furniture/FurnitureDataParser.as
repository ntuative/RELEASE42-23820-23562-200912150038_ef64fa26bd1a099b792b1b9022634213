package com.sulake.habbo.session.furniture
{
   ...
   public class FurnitureDataParser extends EventDispatcher
   {
      ...
      public static const const_140:String = "ready";
       
      
      private var var_2115:Map;
      ...
      private function parseFurnitureData(param1:Event) : void
      {
         ...
         for each(_loc10_ in _loc8_)
         {
            ...
            for each(_loc12_ in _loc11_)
            {
               ...
               if(_loc14_ == "s")
               {
                  var_1091.add(_loc15_,_loc28_);
               }
               else if(_loc14_ == "i")
               {
                  var_603.add(_loc15_,_loc28_);
               }
               var_2115.add(_loc17_,_loc15_);
            }
            _loc9_++;
         }
         dispatchEvent(new Event(const_140));
      }
