package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1824 = new RoomThumbnailRenderer(param1);
         var_938 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_172,var_118.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_172.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_172.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_938.refreshTags(_loc1_,var_118.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1824.refreshThumbnail(_loc1_,var_118.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_172 == null)
         {
            var_172 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_172.visible = true;
         Util.hideChildren(var_172);
         refreshRoomName(var_172,var_118);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_172,!true ? getEventCtg(var_118.categoryId) : getRoomCtg(var_118.categoryId));
         refreshRoomDesc(var_172,var_118);
         refreshExtraCont();
         refreshInfo(var_172,"trading_allowed",var_118.allowTrading);
         refreshInfo(var_172,"doormode_doorbell",false);
         refreshInfo(var_172,"doormode_password",false);
         Util.moveChildrenToColumn(var_172,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_172.height = Util.getLowestPoint(var_172);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_196,Tabs.const_219,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
