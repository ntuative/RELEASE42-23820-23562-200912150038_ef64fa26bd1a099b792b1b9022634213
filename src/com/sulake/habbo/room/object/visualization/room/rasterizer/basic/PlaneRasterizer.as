package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_729:String = "default";
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_166.getValue(_loc6_) == null)
               {
      ...
      public function dispose() : void
      {
         ...
         if(var_166 != null)
         {
            ...
            {
               _loc3_ = var_166.getWithIndex(_loc1_) as PlaneTexture;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return var_166.getValue(param1) as PlaneTexture;
      }
