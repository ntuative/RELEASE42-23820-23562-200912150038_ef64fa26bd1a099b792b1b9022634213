package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1068:String = "content";
      
      private static const const_1067:String = "selector";
       
      
      private var var_1262:Boolean = false;
      
      protected var var_874:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1525 == null)
         {
            var_1525 = findChildByTag(TabContextController.const_1068) as IWindowContainer;
         }
         return var_1525;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_874 == null)
         {
            var_874 = findChildByTag(TabContextController.const_1067) as ITabSelectorWindow;
            if(var_874 != null)
            {
               var_874.procedure = selectorEventProc;
            }
         }
         return var_874;
      }
