package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:BitmapData) : void
      {
         ...
         var _loc3_:BitmapDataCacheItem = var_345.getValue(param1) as BitmapDataCacheItem;
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.bitmapData;
            if(_loc4_ != null)
            {
               var_484 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         else
         {
            ...
            var_345.add(param1,_loc3_);
            var_344.push(_loc3_);
         }
         var_484 += param2.width * param2.height * 4;
      }
      
      public function compress() : void
      {
         var_344.sortOn("useCount",0 | 0);
         var _loc1_:* = null;
         var _loc2_:int = 0;
         if(memUsage > memLimit)
         {
            ...
            while(_loc2_ >= 0)
            {
               _loc1_ = var_344[_loc2_] as BitmapDataCacheItem;
               if(_loc1_.useCount == 0)
               {
                  var_344.splice(_loc2_,1);
                  removeItem(_loc1_);
               }
               _loc2_--;
            }
         ...
         {
            _loc1_ = var_344.pop() as BitmapDataCacheItem;
            if(_loc1_ == null)
            {
               break;
            }
      ...
      {
         var _loc2_:BitmapDataCacheItem = var_345.getValue(param1) as BitmapDataCacheItem;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function removeItem(param1:BitmapDataCacheItem) : void
      {
         ...
         param1 = var_345.remove(param1.name) as BitmapDataCacheItem;
         if(param1 != null)
         {
            _loc2_ = param1.bitmapData;
            if(_loc2_ != null)
            {
               var_484 -= _loc2_.width * _loc2_.height * 4;
            }
            param1.dispose();
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_345.length)
            {
               _loc2_ = var_345.getWithIndex(_loc1_) as BitmapDataCacheItem;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
