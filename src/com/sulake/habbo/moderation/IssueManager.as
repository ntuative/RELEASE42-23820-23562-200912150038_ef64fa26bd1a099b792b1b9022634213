package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_831:String = "issue_bundle_open";
      ...
      private var var_516:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_128 = new Map();
         var_752 = new Map();
         var_516 = new IssueBrowser(this,var_62.windowManager,var_62.assets);
         var_617 = [];
         var_751 = [];
         var_904 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_904.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         var _loc2_:* = [];
         var _loc3_:int = var_62.sessionDataManager.userId;
         for each(_loc4_ in var_128)
         {
            switch(param1)
            {
               case const_831:
                  ...
                  break;
               case const_557:
                  if(_loc4_.state == IssueMessageData.const_411 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_617 = var_617.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_752.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_752.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1252)
         {
            var_161.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_128)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_752.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_752.add(param1.issueId,_loc2_);
         ...
         if(var_617.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_145)
         {
            ...
            _loc8_ = var_751.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = new IssueHandler(var_62,_loc2_);
         var_904.remove(param1);
         var_904.add(param1,_loc3_);
         var_62.windowTracker.show(_loc3_,null,false,false,false);
         var_617 = [];
      }
      
      private function sendClose(param1:Array, param2:int) : void
      {
         if(param1 == null || var_62 == null || true)
         {
            return;
         }
         var_62.connection.send(new CloseIssuesMessageComposer(param1,param2));
      }
      ...
      private function sendPick(param1:Array) : void
      {
         ...
         var_62.connection.send(new PickIssuesMessageComposer(param1));
      }
      ...
      public function releaseAll() : void
      {
         ...
         var _loc1_:int = var_62.sessionDataManager.userId;
         var _loc2_:* = [];
         for each(_loc3_ in var_128)
         {
            if(_loc3_.state == IssueMessageData.const_411 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         if(param1 == null || param1.length == 0 || var_62 == null || true)
         {
            return;
         }
         var_62.connection.send(new ReleaseIssuesMessageComposer(param1));
         var_751 = var_751.concat(param1);
      }
      ...
      {
         var _loc2_:* = var_904.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function updatePriorities() : void
      {
         ...
         var _loc3_:int = parseInt(var_62.configuration.getKey("chf.score.updatefactor","60"));
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_516 == null || !var_516.isOpen())
         {
            var_62.soundManager.playSound(HabboSoundTypesEnum.const_853);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_752.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_128.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         var _loc4_:int = var_62.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_411 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
