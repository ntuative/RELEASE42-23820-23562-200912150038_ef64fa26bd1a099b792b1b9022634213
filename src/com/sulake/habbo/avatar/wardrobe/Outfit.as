package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1381 = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_101);
         var_1381.setDirection(AvatarSetType.const_38,int(FigureData.const_976));
         _image = var_1381.getImage(AvatarSetType.const_38);
         _view.udpate(_image);
      }
