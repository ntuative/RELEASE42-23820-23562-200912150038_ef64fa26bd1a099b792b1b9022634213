package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_169:HabboHotelView;
      ...
      private var var_1743:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1383:ILogger;
      
      private var var_1136:String;
      
      private var var_1744:String;
      
      private const const_1365:String = "fuselogin";
      
      private var var_669:ICoreCommunicationManager;
      
      private var var_446:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_933)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_20);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_298:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_800:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_862:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_810:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1745)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_626 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_626);
            _loc2_.send(_loc4_);
      ...
      {
         var_933 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_23);
         param1.send(new VersionCheckMessageComposer(401,var_1136,var_1744));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1365,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_446.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_446.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1743);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1365,"/");
      ...
      {
         var_626 = _habboConfiguration.getKey("sso.ticket",null);
         var_1136 = _habboConfiguration.getKey("flash.client.url","");
         var_1744 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
            var_169 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_626 != null)
         {
            var_76.mode = HabboConnectionType.const_363;
            var_76.initConnection(HabboConnectionType.const_225);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1383 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1743 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_76.mode)
         {
            case HabboConnectionType.const_363:
               _loc6_ = "";
               ...
               var_932 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_932,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1291:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1260:
               var_931 = generateRandomHexString(30);
               var_446 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_446.init(var_931);
               _loc8_ = var_446.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_169.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_932);
         ...
         var_446 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_931 = generateRandomHexString(30);
            var_446.init(var_931);
            _loc12_ = var_446.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_10);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_16,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_92,onRoomSessionEnded);
      }
