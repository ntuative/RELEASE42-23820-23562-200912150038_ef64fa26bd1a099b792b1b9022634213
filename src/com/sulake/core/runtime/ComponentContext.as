package com.sulake.core.runtime
{
   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected var var_240:Array;
      
      protected var var_873:Boolean = false;
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,CoreComponent.const_1320);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < var_240.length)
         {
            if(var_240[_loc3_].url == param1.url)
            {
               return var_240[_loc3_].loadFromFile(param1);
            }
            _loc3_++;
         }
         var _loc4_:LibraryLoader = new LibraryLoader(var_873);
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc8_:uint = var_185.mapStructsByImplementor(this,_loc7_);
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_)
         {
         ...
         var _loc11_:int = 0;
         while(_loc11_ < var_276.length)
         {
            _loc10_ = var_276[_loc11_] as Component;
            if(_loc10_ != this)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_352 != null)
            {
               ...
               while(_loc1_-- > 0)
               {
                  IDisposable(var_352.pop()).dispose();
               }
               var_352 = null;
            }
            if(var_240 != null)
      ...
      protected final function hasQueueForInterface(param1:IID) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(var_352[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,CoreComponent.const_1119);
      }
      
      public final function detachComponent(param1:Component) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = var_185.getIndexByImplementor(param1);
         while(_loc3_ > -1)
         {
            _loc2_ = var_185.remove(_loc3_);
            _loc3_ = var_185.getIndexByImplementor(param1);
         }
         var _loc4_:int = 0;
         while(_loc4_ < var_276.length)
         {
            if(var_276[_loc4_] == param1)
            {
               var_276.splice(_loc4_,1);
               return;
            }
            _loc4_++;
         }
      ...
      public final function attachComponent(param1:Component, param2:Array) : void
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            var_185.insert(new InterfaceStruct(_loc5_,param1));
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
         ...
         while(_loc18_ < _loc5_.length())
         {
            ...
            if(_loc24_ > 0)
            {
               ...
               while(_loc26_ < _loc24_)
               {
                  ...
                  {
                     error("Manifest for component " + _loc7_ + " contains broken asset \"" + _loc21_ + "\"!",true,CoreComponent.const_529);
                  }
                  _loc26_++;
               }
            }
            ...
            if(_loc6_ == null)
            {
               error("Invalid component class " + _loc7_ + "!",true,CoreComponent.const_529);
               return false;
            }
            ...
            if(_loc4_ != null)
            {
               if(_loc25_ != null)
               {
                  ...
                  {
                     _loc25_.dispose();
                     error("Component \"" + _loc7_ + "\" did not save provided asset library!",true,CoreComponent.const_529);
                  }
               }
