package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_669.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_122,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_979,method_7);
         events.addEventListener(HabboToolbarSetIconEvent.const_167,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_154,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_48,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_453,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_564,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_806,onHideWindowEvent);
         _state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_80));
      }
      ...
      private function method_7(param1:HabboToolbarSetIconEvent) : void
      {
         if(_view != null && _state)
         {
