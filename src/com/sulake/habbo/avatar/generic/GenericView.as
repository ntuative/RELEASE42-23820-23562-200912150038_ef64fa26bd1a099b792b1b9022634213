package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      private var var_91:GenericModel;
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_597["null"] = new AvatarEditorGridView(param1,FigureData.const_54,param2,param3);
         attachImages();
         switchCategory(FigureData.const_54);
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_boy":
                  var_91.categorySwitch(FigureData.const_78);
                  param1.stopPropagation();
                  break;
               case "tab_girl":
                  var_91.categorySwitch(FigureData.const_74);
                  param1.stopPropagation();
            }
         }
      ...
      {
         var _loc4_:AvatarEditorGridView = var_597[param1];
         if(_loc4_ != null)
         {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(var_91.controller.gender)
         {
         ...
         var _loc4_:AvatarEditorGridView = var_597[var_1334];
         if(_loc4_ == null)
         {
            return;
         }
