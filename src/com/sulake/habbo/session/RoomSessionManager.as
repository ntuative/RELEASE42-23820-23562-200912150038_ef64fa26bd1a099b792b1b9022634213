package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         var_733 = true;
         if(var_188.getValue(_loc6_) != null)
         {
         ...
         var_188.add(_loc6_,_loc7_);
         _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_311,_loc7_));
         return true;
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1073)
         {
            gotoRoom(var_1603,var_1604,var_1074);
            var_1073 = false;
            var_1074 = "";
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_188)
         {
            while(false)
            {
               _loc1_ = var_188.getKey(0) as String;
               _loc2_ = var_188.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return var_188.getValue(_loc3_) as IRoomSession;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = var_188.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = getRoomIdentifier(param3,param4);
            _loc7_ = var_188.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            var_188.add(_loc5_,_loc6_);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = var_188.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_92,_loc4_));
            _loc4_.dispose();
         }
      }
