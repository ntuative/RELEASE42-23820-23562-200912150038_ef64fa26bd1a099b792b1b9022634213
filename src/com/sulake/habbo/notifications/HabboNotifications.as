package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1026:String = "badges";
      
      private static const const_1030:String = "pixelbalance";
      
      private static const const_1031:String = "credits";
      
      private static const const_1028:String = "inventory";
      
      private static const const_1027:String = "friendlist";
      
      private static const const_1029:String = "selectfurni";
      
      private static const const_1032:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_525:ParkBusDialogManager;
      
      private var var_1123:IHabboToolbar;
      ...
      private var var_376:HabboNotificationViewManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_766);
         }
         var _loc6_:Map = var_766["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1147);
         }
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1148);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1727)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_877);
            var_1727 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1115.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_820,_loc5_);
         }
      }
      ...
      {
         if(param1 != null && this.var_376 != null)
         {
            var_376.replaceIcon(param1);
         }
      }
      ...
      {
         if(var_376.isSpaceAvailable() && false)
         {
            var_376.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_525 == null)
         {
            var_525 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_525 != null)
         {
            var_525.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_918.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1115.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_571);
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_152 || param2.type == WindowEvent.const_690)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc15_.productType == CatalogPageMessageProductData.const_84)
               {
                  _loc16_ = var_571.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_81)
               {
                  _loc16_ = var_571.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_571.getProductData(_loc4_.localizationId);
               switch(_loc15_.productType)
               {
                  ...
                  case CatalogPageMessageProductData.const_81:
                     ...
                     break;
                  case CatalogPageMessageProductData.const_261:
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_877,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1115.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      {
         var_1123 = IHabboToolbar(param2);
         var_1123.events.addEventListener(HabboToolbarEvent.const_80,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_206);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_571.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_867);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_867);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_325;
            }
            if(param2 == 4057)
            {
               return FurniCategory.const_275;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_80)
         {
            ...
            var_376 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_766["styles"],var_766["view"],var_1123);
            ...
            registerUpdateReceiver(var_376,1);
            registerUpdateReceiver(this,2);
            var_571.events.addEventListener(BadgeImageReadyEvent.const_115,onBadgeImage);
            var_1123.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
