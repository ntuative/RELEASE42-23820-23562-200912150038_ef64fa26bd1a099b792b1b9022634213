package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1589:int = 5;
      
      private const const_1588:int = 5;
      ...
      private function createTag(param1:String) : ITextWindow
      {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_113);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_786 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_786 += param1.height + const_1588;
            return fit(param1);
         }
         param1.offset(_offsetX,var_786);
         _offsetX += param1.width + const_1589;
         return true;
      }
