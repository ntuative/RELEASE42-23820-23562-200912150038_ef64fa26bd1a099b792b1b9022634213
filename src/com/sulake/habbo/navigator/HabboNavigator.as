package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2287:Dictionary;
      ...
      private var var_2113:ISessionDataManager;
      
      private var var_2114:RoomCreateViewCtrl;
      
      private var var_1824:RoomThumbnailRenderer;
      
      private var var_189:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1263:RoomInfoViewCtrl;
      
      private var var_70:IHabboCatalog;
      
      private var var_402:Tabs;
      
      private var var_486:MainViewCtrl;
      
      private var var_2112:Array;
      
      private var var_1006:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_486 = new MainViewCtrl(this);
         var_1263 = new RoomInfoViewCtrl(this);
         var_2114 = new RoomCreateViewCtrl(this);
         var_1824 = new RoomThumbnailRenderer(this);
         var_1006 = new GuestRoomPasswordInput(this);
         var_317 = new GuestRoomDoorbell(this);
         var_402 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_486.startSearch(Tabs.const_196,Tabs.const_321,param1);
         var_486.mainWindow.activate();
      }
      ...
      public function goToRoom(param1:int, param2:Boolean, param3:String = "") : void
      {
         ...
         if(var_33)
         {
            ...
            var_1263.close();
            var_33.gotoRoom(false,param1,param3);
         }
      }
      ...
      public function goToPublicSpace(param1:int, param2:String) : void
      {
         ...
         {
            var_1263.close();
            var_33.gotoRoom(true,param1,"",param2);
         }
      }
      
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         if(param1 != null && var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_170.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2113 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_486.startSearch(Tabs.const_259,Tabs.const_199);
         var_402.getTab(Tabs.const_259).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_486.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
