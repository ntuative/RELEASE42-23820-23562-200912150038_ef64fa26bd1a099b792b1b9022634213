package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_608:Number = 0;
      
      private var var_318:int = 0;
      
      private var var_319:int = 0;
      
      private var var_1142:Number = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_906;
         }
         var _loc2_:RoomPlaneData = var_109[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.type;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_146,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_255,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_775);
         addPlane(RoomPlaneData.const_146,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_146,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_115) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_146,Vector3d.sum(param1,Vector3d.product(param3,-var_115 / param3.length)),Vector3d.product(param3,(param3.length + var_115) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_775 / param2.length);
               addPlane(RoomPlaneData.const_146,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || var_108 == null || param1 == var_108)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > var_108.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = var_108[_loc3_] as Array;
      ...
      private function getTileHeightInternal(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = var_108[param2] as Array;
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = var_109[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(var_108);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         var_608 = getFloorHeight(var_108);
         if(!param1)
         {
            createWallPlanes();
         }
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < var_108.length)
         {
            _loc4_ = var_108[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            _loc4_ = var_108[param2] as Array;
            ...
            {
               if(param1 == var_319 || param1 == var_320)
               {
                  _loc5_ = false;
                  _loc6_ = var_318;
                  while(_loc6_ < var_321)
                  {
               ...
               if(param2 == var_318 || param2 == var_321)
               {
                  _loc7_ = false;
                  _loc8_ = var_319;
                  while(_loc8_ < var_320)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_137,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_137,_loc13_,new Vector3d(0,0,-var_115),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,var_115,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,var_115,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_137,_loc13_,new Vector3d(0,0,-var_115),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,var_115,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,var_115,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_137,_loc13_,new Vector3d(0,0,-var_115),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,var_115,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,var_115,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_137,_loc13_,new Vector3d(0,0,-var_115),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,var_115,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,var_115,param11);
                  }
               }
            }
         }
