package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_343:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_63))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_343)
         {
            var_343 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_343)
            {
               var_343.addEventListener(WindowEvent.const_239,scrollBarEventProc);
               var_343.addEventListener(WindowEvent.const_213,scrollBarEventProc);
            }
         }
         return var_343;
      }
      ...
      override public function dispose() : void
      {
         if(var_343)
         {
            var_343.removeEventListener(WindowEvent.const_239,scrollBarEventProc);
            var_343.removeEventListener(WindowEvent.const_213,scrollBarEventProc);
            var_343 = null;
         }
         if(_cachedItemList)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_213)
         {
            hideScrollBar();
         }
      }
