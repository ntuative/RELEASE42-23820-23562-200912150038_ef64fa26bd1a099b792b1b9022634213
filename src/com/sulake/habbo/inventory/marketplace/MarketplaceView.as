package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private var var_91:MarketplaceModel;
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         checkPrice();
         _localization.registerParameter("inventory.marketplace.make_offer.expiration_info","time",var_91.expirationHours.toString());
         _localization.registerParameter("inventory.marketplace.make_offer.min_price","minprice",var_91.offerMinPrice.toString());
         _localization.registerParameter("inventory.marketplace.make_offer.max_price","maxprice",var_91.offerMaxPrice.toString());
         if(param1 is FloorItem)
         {
            _loc4_ = _roomEngine.getFurnitureImage(param1.type,new Vector3d(180,0,0),32,this,4293848814);
         }
         else
         {
            _loc4_ = _roomEngine.getWallItemImage(param1.type,new Vector3d(180,0,0),32,this,param1.extras,4293848814);
         }
         var_1861 = _loc4_.id;
         setFurniImage(_loc4_.data);
         var_1862 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_1862);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1408.toString());
      ...
      {
         var _loc1_:* = null;
         if(false && "HabboAvatarRenderLib_fx15" == _config.getKey("client.credits.embed.enabled"))
         {
      ...
      private function checkPrice() : void
      {
         ...
         if(_loc2_ > var_91.offerMaxPrice)
         {
            _loc1_.text = var_91.offerMaxPrice.toString();
            _loc2_ = 0;
         }
         ...
         if(_loc2_ < var_91.offerMinPrice)
         {
