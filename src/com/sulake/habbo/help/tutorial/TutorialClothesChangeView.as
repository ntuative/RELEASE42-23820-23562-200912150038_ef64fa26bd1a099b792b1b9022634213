package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private var var_531:IWindowContainer;
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_55.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_48,onShowMenuEvent);
         var_55.prepareForTutorial();
      }
      
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  var_55.showView(TutorialUI.const_76);
               }
         }
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_48)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_55.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_399));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_531 = var_55.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_531.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_55.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU_ARROW,var_531));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_55.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_48,onShowMenuEvent);
      }
   }
}
