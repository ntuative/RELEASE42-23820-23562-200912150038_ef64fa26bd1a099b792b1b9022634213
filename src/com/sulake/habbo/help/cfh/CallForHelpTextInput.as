package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1097:int = 30;
      
      private static const const_1076:int = 253;
      
      private static const const_1075:int = 10;
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "send":
               ...
               break;
            case "cancel":
               main.showUI(HabboHelpViewEnum.const_132);
               break;
            default:
