package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1436:uint = 1;
      ...
      protected var var_371:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_2064:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_876 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_876);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1043 & const_967)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_371 + "]";
      }
   }
}
