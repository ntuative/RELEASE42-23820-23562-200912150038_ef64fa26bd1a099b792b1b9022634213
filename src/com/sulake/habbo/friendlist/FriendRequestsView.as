package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1370:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_302 && _loc4_.state != FriendRequest.const_326)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_302;
      ...
      {
         var_1353 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1354 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1354.procedure = onDismissAllButtonClick;
         var_1353.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_100,param2);
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_326;
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1353,_loc1_);
         setEnabled(var_1354,_loc1_);
      }
