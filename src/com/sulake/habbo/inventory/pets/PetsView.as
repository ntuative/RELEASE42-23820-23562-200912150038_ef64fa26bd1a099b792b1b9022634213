package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_285:PetsGridItem;
      ...
      private var var_485:IItemGridWindow;
      
      private var var_91:PetsModel;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_485 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_519 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_519.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_285 != null)
         {
            var_285.setSelected(false);
         }
         var_285 = param1;
         if(var_285 != null)
         {
            var_285.setSelected(true);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_52)
         {
            ...
            {
               case "tab_floor":
                  var_91.switchCategory(FurniModel.const_41);
                  break;
               case "tab_wall":
                  var_91.switchCategory(FurniModel.const_42);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_285.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateGrid() : void
      {
         ...
         var_485.removeGridItems();
         var_519.reset();
         var _loc1_:Map = var_91.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         var_91.placePetToRoom(param1,param2);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = var_519.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_485.removeGridItem(_loc2_.window);
         if(var_285 == _loc2_)
         {
            var_285 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_519.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_485.addGridItem(_loc2_.window);
            var_519.add(param1.id,_loc2_);
            if(var_285 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(false)
         {
            _loc8_ = var_91.roomSession.arePetsAllowed;
            _loc9_ = var_91.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
