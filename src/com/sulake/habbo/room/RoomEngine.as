package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_490:String = "room";
      
      private static const const_769:int = -2;
      
      private static const const_491:String = "temporary_room";
      
      private static const const_273:String = "object_icon_sprite";
      
      private static const const_768:int = -3;
      
      private static const const_770:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1103:String = "tile_cursor";
      
      private static const const_272:int = -1;
       
      
      private var var_360:IRoomObjectVisualizationFactory = null;
      
      private var var_488:Boolean = false;
      
      private var var_26:RoomContentLoader = null;
      
      private var var_302:Map = null;
      
      private var _connection:IConnection = null;
      
      private var var_432:IAdManager = null;
      
      private var var_574:NumberBank;
      ...
      private var var_696:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_303 = new Map();
         var_574 = new NumberBank(1000);
         var_1023 = new Map();
         var_302 = new Map();
         var_71 = new RoomObjectEventHandler(this);
         var_696 = new RoomMessageHandler(this);
         var_26 = new RoomContentLoader();
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_71 != null)
         {
            ...
            {
               return var_71.deleteWallItem(var_120,var_121,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_303.length; _loc2_++)
         {
            _loc3_ = var_303.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_534) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_573) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_510) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_712) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_141);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_71 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_71.modifyWallItemData(var_120,var_121,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_360 != null)
         {
            var_360.release(new IIDRoomObjectVisualizationFactory());
            var_360 = null;
         }
         if(var_49 != null)
         {
         ...
         if(var_303 != null)
         {
            ...
            {
               _loc2_ = var_303.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_878;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            if(isPublicRoomWorldType(_loc12_))
            {
               if(var_26 != null)
               {
                  if(var_26.getPublicRoomWorldSize(_loc12_) != 64)
                  {
                     _loc10_.geometry.performZoomOut();
                  }
               }
            }
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_515);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_506);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_523);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_814);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_951);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_913) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_801);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_427,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function getRoomObjectAdURL(param1:String) : String
      {
         if(var_26 != null)
         {
            return var_26.getRoomObjectAdURL(param1);
         }
         return "";
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_584,var_120,var_121,param2,param3));
            }
         }
      }
      ...
      public function loadRoomResources(param1:String) : Array
      {
         if(var_26 != null)
         {
            return var_26.loadLegacyContent(param1,_events);
         }
         return new Array();
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_71 != null)
         {
            return var_71.modifyRoomObject(var_120,var_121,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_302.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_302.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_540,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_558,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_563,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_49 != null)
         {
            var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_32);
            var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_29);
            var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_35);
            var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_250);
            var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_60);
            var_49.setContentLoader(var_26);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_71 != null)
         {
            var_71.handleRoomObjectEvent(param1,var_120,var_121);
         }
      }
      ...
      private function getFurnitureType(param1:int) : String
      {
         if(var_26 != null)
         {
            return var_26.getActiveObjectType(param1);
         }
         return "";
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_201,_loc10_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_323,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_327,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_881,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_251,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_616,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(_roomObjectFactory == null || var_360 == null || var_49 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_2127)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_272,RoomObjectCategoryEnum.const_60);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(isPublicRoomWorldType(_loc9_) && var_26 != null)
         {
            _loc11_ = var_26.getPublicRoomContentType(_loc9_) + "_";
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1208,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_49.getRoom(getRoomIdentifier(var_120,var_121));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_768,RoomObjectCategoryEnum.const_250);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_121,var_1268);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_273);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_121,var_1268);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_273);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_360 = param2 as IRoomObjectVisualizationFactory;
         if(var_26 != null)
         {
            var_26.visualizationFactory = var_360;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_195,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_448,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_407,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_223,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_602,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_120,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_123,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_105,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_89,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_375,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_456,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_377,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_468,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_353,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_454,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_413,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_395,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_366,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectDimmerStateUpdateEvent.DIMMER_STATE,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_387,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_398,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_236,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_388,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_296,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_301,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_394,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_852,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_474,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_397,warningEventHandler);
            }
         }
      }
      ...
      private function getWallItemColorIndex(param1:int) : int
      {
         if(var_26 != null)
         {
            return var_26.getWallItemColorIndex(param1);
         }
         return 0;
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         if(var_26 != null)
         {
            return var_26.getObjectCategory(param1);
         }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_120,var_121);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_643) != 0)
         {
            return false;
         }
         if(var_71 != null)
         {
            return var_71.initializeRoomObjectInsert(var_120,var_121,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_302.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_251,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
            ...
            if(_loc13_ != null && _loc13_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc13_.getModel().getNumber(RoomObjectVariableEnum.const_201));
                     break;
                  case RoomObjectCategoryEnum.const_35:
                     _loc10_ = _loc13_.getModel().getString(RoomObjectVariableEnum.const_155);
               }
            }
         }
      ...
      private function getWallItemType(param1:int, param2:String = null) : String
      {
         if(var_26 != null)
         {
            return var_26.getWallItemType(param1,param2);
         }
         return "";
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_282);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_669)
         {
            var_2127 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_201,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_323,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_327,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_878,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_251,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_432.events.addEventListener(AdEvent.const_441,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_770) as Sprite;
      }
      ...
      private function getFurnitureColorIndex(param1:int) : int
      {
         if(var_26 != null)
         {
            return var_26.getActiveObjectColorIndex(param1);
         }
         return 0;
      }
      ...
      public function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:uint = 0) : ImageResult
      {
         ...
         if(var_26 != null)
         {
            _loc6_ = var_26.getActiveObjectType(param1);
            _loc7_ = String(var_26.getActiveObjectColorIndex(param1));
         }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_303.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0) : ImageResult
      {
         ...
         _loc8_.id = -1;
         if(!var_488 || param1 == null)
         {
            return _loc8_;
         }
         var _loc9_:IRoomInstance = var_49.getRoom(const_491);
         if(_loc9_ == null)
         {
            _loc9_ = var_49.createRoom(const_491,null);
            if(_loc9_ == null)
            {
               return _loc8_;
            }
         }
         var _loc10_:int = var_574.reserveNumber();
         ...
         switch(_loc11_)
         {
            case RoomObjectCategoryEnum.const_32:
            case RoomObjectCategoryEnum.const_29:
               _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_201,int(param2));
               break;
            case RoomObjectCategoryEnum.const_35:
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_155,param2);
               break;
            case RoomObjectCategoryEnum.const_60:
               if(param2 != null)
               {
                  ...
                  if(_loc16_.length >= 3)
                  {
                     ...
                     _loc20_.addPlane(RoomPlaneData.const_137,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc20_.addPlane(RoomPlaneData.const_255,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_ = _loc20_.getXML();
                     _loc12_.getEventHandler().initialize(_loc21_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_496,_loc17_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_542,_loc18_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_703,_loc19_);
                     if(param6 != null)
                     {
                        _loc22_ = null;
                        _loc23_ = "undefined_" + _loc10_;
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_427,_loc23_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1023.add(String(_loc10_),param5);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_988,param4,true);
         }
         else
         {
            _loc9_.disposeObject(_loc10_,_loc11_);
            var_574.freeNumber(_loc10_ - 1);
            _loc8_.id = 0;
         }
         _loc14_.dispose();
         return _loc8_;
      ...
      public function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(var_26 != null)
         {
            _loc7_ = var_26.getWallItemType(param1,param5);
            _loc8_ = String(var_26.getWallItemColorIndex(param1));
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_769,RoomObjectCategoryEnum.const_250);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_121,param1);
         if(_loc9_ != null)
         {
            var_1268 = param1;
            var_1502 = param2;
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_273);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1502 - _loc12_.width / 2;
               _loc11_.y = var_1503 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_440,var_120,var_121,-1,RoomObjectCategoryEnum.const_205));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_71 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_272,const_490);
                  var_71.handleRoomObjectEvent(_loc14_,var_120,var_121);
               }
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_26 != null)
         {
            var_26.setRoomObjectAlias(param1,param2);
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_120,var_121,param1,param2,new Vector3d(),1,null);
         }
         else if(var_26 != null)
         {
            _loc8_ = null;
            ...
            {
               _loc8_ = var_26.getActiveObjectType(param1);
               _loc9_ = var_26.getActiveObjectColorIndex(param1);
            }
            else if(param2 == RoomObjectCategoryEnum.const_29)
            {
               _loc8_ = var_26.getWallItemType(param1,param4);
               _loc9_ = var_26.getWallItemColorIndex(param1);
            }
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_121,var_1268);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_273);
            _loc11_ = addOverlayIconSprite(_loc10_,const_273,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1502 - _loc6_.data.width / 2;
               _loc11_.y = var_1503 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_26 != null)
         {
            ...
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_299,param1.image,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_953,param1.adWarningL,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_854,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_772,RoomObjectVariableEnum.const_299,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_303.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_303.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function isPublicRoomWorldType(param1:String) : Boolean
      {
         if(var_26 != null)
         {
            return var_26.isPublicRoomWorldType(param1);
         }
         return false;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_26 != null)
         {
            _events.addEventListener(RoomContentLoader.const_669,onContentLoaderReady);
            var_26.initialize(_events,_habboConfiguration);
         }
         initializeRoomManager();
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_71 != null)
         {
            var_71.cancelRoomObjectInsert(var_120,var_121);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_49.getRoom(const_491);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc4_:* = null;
         var _loc5_:* = 0;
         var _loc6_:int = var_26.getObjectCategory(param1);
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_988);
               ...
               var_574.freeNumber(_loc10_ - 1);
               _loc13_ = var_1023.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_120,var_121,const_272,RoomObjectCategoryEnum.const_60,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         {
            _loc12_ = var_26.getPublicRoomContentType(param6);
            _loc9_ = _loc7_.createRoomObject(const_272,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_826,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_643,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_777,_loc13_,true);
            if(var_26 != null)
            {
               _loc10_ = Number(var_26.getPublicRoomWorldHeightScale(param6));
            }
         }
         else
         {
            _loc9_ = _loc7_.createRoomObject(const_272,const_490,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_643,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_515,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_534,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_510,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_573,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_712,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_799,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_540,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_558,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_563,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_427,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_189);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_506,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_523,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_506,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_523,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_814,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_951,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_769,const_1103,RoomObjectCategoryEnum.const_250);
         _loc7_.createRoomObject(const_768,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_250);
         return _loc7_;
      }
