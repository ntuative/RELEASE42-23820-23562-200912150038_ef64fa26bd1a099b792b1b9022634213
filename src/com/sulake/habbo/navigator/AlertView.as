package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_navigator.getXmlWindow(this.var_1049));
      ...
      public function show() : void
      {
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_263.desktop,var_263.width,var_263.height);
         var_263.x = _loc2_.x;
         var_263.y = _loc2_.y;
