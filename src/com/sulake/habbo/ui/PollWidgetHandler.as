package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_419;
      }
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_436,RoomWidgetPollMessage.const_650];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_127:
               ...
               break;
            case RoomSessionPollEvent.const_56:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_56);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_104:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_104);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_650:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionPollEvent.const_56);
         _loc1_.push(RoomSessionPollEvent.const_104);
         return _loc1_;
      }
