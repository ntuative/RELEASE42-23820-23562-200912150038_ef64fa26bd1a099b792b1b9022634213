package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1390:IIssueBrowserView;
      
      private const const_1585:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1586:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1389:IIssueBrowserView;
      
      private const const_1598:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1587:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_216:ITabContextWindow;
      
      private var var_1391:PickedIssuesView;
      
      private var var_322:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_322.view.width = var_216.container.width;
         var_322.view.height = var_216.container.height;
         var_322.visible = true;
         var_322.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1587:
               if(var_1389 == null)
               {
                  var_1389 = new MyIssuesView(issueManager,this,var_216.container);
               }
               return var_1389;
            case const_1585:
               if(var_1390 == null)
               {
                  var_1390 = new OpenIssuesView(issueManager,this,var_216.container);
               }
               return var_1390;
            case const_1586:
               if(var_1391 == null)
               {
                  var_1391 = new PickedIssuesView(issueManager,this,var_216.container);
               }
               return var_1391;
            default:
               return null;
