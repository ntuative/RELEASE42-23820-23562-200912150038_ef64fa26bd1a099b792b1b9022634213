package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1374:Rectangle;
      
      private var var_288:Dictionary;
      ...
      private var var_287:Rectangle;
      
      private var var_1375:Point;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_522 = new Array();
         var_1375 = new Point();
         var_1374 = new Rectangle();
         var_287 = new Rectangle();
         var_288 = new Dictionary(true);
         var_644 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_288[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_522.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = method_2(_loc1_);
               var_287.x = _loc3_.dirty.x;
               var_287.y = _loc3_.dirty.y;
               var_287.width = _loc3_.dirty.width;
               var_287.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_287);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_546,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_288[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_288[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_522 = null;
            for(_loc1_ in var_288)
            {
               delete var_288[_loc1_];
            }
            var_288 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1375,var_1374))
            {
               if(param2.render(param1,var_1375,var_1374))
               {
                  ...
                  while(_loc7_ < _loc4_)
                  {
                     ...
                     if(_loc6_.intersects(param3))
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_33))
                        {
                           ...
                           renderWindowBranch(_loc5_,method_2(_loc5_),param3);
                           param3.offset(_loc6_.x,_loc6_.y);
                        }
                     }
                     _loc7_++;
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_644);
            var_288[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_546,windowDisposedCallback);
         }
      }
      ...
      protected function method_2(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = var_288[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            registerRenderable(param1);
            _loc2_ = var_288[param1];
         }
         return _loc2_;
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(method_2(param1).invalidate(param1,param2,param3))
         {
            _loc5_ = param1.context.getDesktopWindow();
            var_287.x = param2.x - param1.x;
            var_287.y = param2.y - param1.y;
            var_287.width = param2.width;
            var_287.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  var_287.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            method_2(param1).invalidate(param1,var_287,WindowRedrawFlag.const_245);
            if(var_522.indexOf(param1) == -1)
            {
               var_522.push(param1);
            }
         }
