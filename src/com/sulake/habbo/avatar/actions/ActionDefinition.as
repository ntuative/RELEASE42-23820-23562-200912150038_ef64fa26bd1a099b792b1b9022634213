package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1357 = new Dictionary();
         super();
         _id = String(param1.@id);
         _state = String(param1.@state);
         var_1646 = parseInt(param1.@precedence);
         var_1647 = String(param1.@activepartset);
         var_1645 = String(param1.@assetpartdefinition);
         var_1643 = String(param1.@lay);
         var_1137 = String(param1.@geometrytype);
         var_1641 = Boolean(parseInt(param1.@main));
         var_1642 = Boolean(parseInt(param1.@method_2));
         var_1648 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1086 = _loc2_.split(",");
         }
      ...
      {
         return var_1086.concat(getTypePrevents(param1));
      }
