package com.sulake.habbo.inventory.recycler
{
   ...
   public class RecyclerModel implements IInventoryModel
   {
      ...
      public function startRecycler() : void
      {
         _state = STATE_ACTIVE;
         _itemList = new Map();
         var_25.furniModel.showRecyclable(true);
      }
      ...
      public function lockSelectedFurni() : int
      {
         ...
         var _loc1_:IItem = var_25.furniModel.requestSelectedFurniToRecycler();
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function stopRecycler() : void
      {
         var _loc2_:int = 0;
         _state = const_1016;
         if(var_25 != null && false)
         {
            var_25.furniModel.showRecyclable(false);
         }
         else
         {
            _itemList = null;
         ...
         while(_loc1_ < _itemList.length)
         {
            ...
            var_25.furniModel.removeLockFrom(_loc2_);
            _loc1_++;
         }
         _itemList = null;
      }
      ...
      public function releaseFurni(param1:int) : Boolean
      {
         ...
         var_25.furniModel.removeLockFrom(param1);
