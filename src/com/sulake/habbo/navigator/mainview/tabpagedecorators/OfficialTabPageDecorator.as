package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class OfficialTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_429:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_429 == null)
         {
            var_429 = IDropMenuWindow(_loc3_.findChildByName("officialSubNavi"));
            var_429.procedure = onChangeNavi;
         }
         if(!var_1565 && _navigator.data.topLevelNodes != null)
         {
            prepareNavi();
         }
         _loc3_.visible = true;
      ...
      {
         var _loc3_:* = null;
         var _loc1_:int = var_429 == null ? 0 : int(var_429.selection);
         var _loc2_:int = -1;
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_227,Tabs.const_447,"" + _loc2_,MainViewCtrl.const_623);
      }
