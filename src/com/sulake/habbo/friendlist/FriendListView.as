package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1379:String = "noconvinfo";
      ...
      private var var_1156:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1156 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_836 = IWindowContainer(var_28.content.findChildByName("main_content"));
         var_266 = IWindowContainer(var_28.content.findChildByName("footer"));
         var_1156.prepare(var_836);
         var_28.procedure = onWindow;
         var_28.content.setParamFlag(HabboWindowParam.const_936,false);
         var_28.content.setParamFlag(HabboWindowParam.const_1346,true);
         var_28.header.setParamFlag(HabboWindowParam.const_521,false);
         var_28.header.setParamFlag(HabboWindowParam.const_937,true);
         var_28.content.setParamFlag(HabboWindowParam.const_521,false);
         var_28.content.setParamFlag(HabboWindowParam.const_937,true);
         var_28.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1157 = ITextWindow(var_28.findChildByName("info_text"));
         var_1157.text = "";
      ...
      public function openFriendList() : void
      {
         ...
         {
            prepare();
            _friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.FRIENDLIST,var_28));
         }
         else
         {
            var_28.visible = true;
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_266.y = Util.getLowestPoint(var_28.content);
         ...
         var_28.scaler.setParamFlag(HabboWindowParam.const_857,this._friendList.tabs.findSelectedTab() != null);
         var_28.scaler.setParamFlag(HabboWindowParam.const_521,false);
         var_28.scaler.setParamFlag(HabboWindowParam.const_936,false);
         var_28.scaler.x = 0 - var_28.scaler.width;
         var_28.scaler.y = 0 - var_28.scaler.height;
         var_1398 = var_28.height;
         var_1397 = var_28.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1398 == -1 ? 0 : int(0 - var_1398);
         var _loc4_:int = var_1397 == -1 ? 0 : int(0 - var_1397);
