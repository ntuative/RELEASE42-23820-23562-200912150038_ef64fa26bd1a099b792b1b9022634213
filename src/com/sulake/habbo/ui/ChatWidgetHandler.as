package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_780:Number = 0;
      
      private var var_448:Point = null;
      
      private var var_630:Map = null;
      ...
      {
         return [RoomSessionChatEvent.const_144];
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_447.length)
            {
               _loc2_ = var_447.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_144:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_447.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_630.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_316:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_101);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_101);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_447.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_630.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_660,RoomWidgetChatSelectAvatarMessage.const_524];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_660:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_144,_container.roomSession,0,"Version 23820-23562-200912150010");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_309);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_389);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_524:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_780 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_780);
            }
            if(var_448 == null)
            {
               var_449.x = 0;
               var_449.y = 0;
               var_449.z = 0;
               var_448 = _loc4_.getScreenPoint(var_449);
               var_780 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_449.x = 0;
            var_449.y = 0;
            var_449.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_449);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_448.x || _loc8_.y != var_448.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_448,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_281;
      }
