   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            _loc8_ = var_109[_loc4_] as FurniturePlane;
            if(_loc8_ != null)
            {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + _loc2_.getInstanceId() + "_" + var_1361;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_109 != null)
         {
            ...
            {
               _loc2_ = var_109[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_402);
