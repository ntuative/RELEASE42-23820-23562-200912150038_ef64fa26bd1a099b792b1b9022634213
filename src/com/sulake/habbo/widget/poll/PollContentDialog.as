package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_45))
                        {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_662[var_985] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_298)
         {
            ...
            var_298 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_298.center();
            var_298.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_985;
         if(var_985 < var_662.length)
         {
            _loc1_ = var_662[var_985] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_662.length);
                  _loc2_.text = _loc6_;
               }
