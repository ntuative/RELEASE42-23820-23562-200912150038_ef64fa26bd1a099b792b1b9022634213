   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_966 = BitmapDataAsset(param1).var_966;
            var_965 = BitmapDataAsset(param1).var_965;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_966 = _loc4_ == "1" || _loc4_ == "HabboAvatarRenderLib_fx15";
                  break;
               case "flipV":
                  var_965 = _loc4_ == "1" || _loc4_ == "HabboAvatarRenderLib_fx15";
                  break;
            }
            _loc2_++;
         }
