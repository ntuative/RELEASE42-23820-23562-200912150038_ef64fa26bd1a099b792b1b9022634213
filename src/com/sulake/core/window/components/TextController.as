package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2245:Rectangle = new Rectangle();
      ...
      protected var var_493:String = "none";
      
      protected var var_578:Number;
      
      protected var var_353:Number;
      
      protected var _field:TextField;
      
      protected var var_702:Boolean = false;
      ...
      {
         return new Rectangle(var_578 * maxScrollH,var_353 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_702)
         {
            context.removeLocalizationListener(var_241,this);
         }
         if(var_72 != null)
         {
            var_72.dispose();
      ...
      {
         var_578 = param1;
         _field.scrollH = var_578 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_241 = param1;
         if(var_241.charAt(0) == "$" && var_241.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_241.slice(2,var_241.indexOf("}")),this);
            var_702 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_206)
         {
            if(param2.type == WindowNotifyEvent.const_254)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_214,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1183,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_369,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_214,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_369,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_214,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_85,true));
         ...
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.const_214,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_715,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_214,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_715,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_left",var_72.left,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("margin_top",var_72.top,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("margin_right",var_72.right,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_72.bottom,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("auto_size",var_493,PropertyStruct.const_214,var_493 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_715,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_578 = var_578;
         _loc1_.var_353 = var_353;
         _loc1_.var_72 = var_72.clone(_loc1_.setTextMargins);
         _loc1_.var_493 = var_493;
         _loc1_.var_702 = var_702;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_493 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_493 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_493 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_493 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
