package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2179:int = -1;
      
      protected var _data:FurnitureVisualizationData = null;
      
      protected var _type:String = "";
      
      protected var var_2180:Number = NaN;
      ...
      private function updateSprites(param1:int, param2:Number) : void
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               _loc8_ = _loc7_.getString(RoomObjectVariableEnum.const_327);
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc6_ < spriteCount - 1)
                  {
                     ...
                     _loc10_.color = getSpriteColor(_loc6_,var_2179,param1);
                  ...
                  else
                  {
                     ...
                     {
                        _loc13_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_156);
                     }
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2179 = _loc3_.getNumber(RoomObjectVariableEnum.const_201);
      ...
      protected function getSpriteAlpha(param1:int, param2:int, param3:int) : int
      {
         ...
         if(_loc5_ != null)
         {
            _loc6_ = Number(_loc5_.getNumber(RoomObjectVariableEnum.const_156));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_278 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2180)
         {
            _loc4_ = _loc3_.getDirection().x - (param2 + 135);
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = _data.getDirectionValue(_loc4_,param1);
            _direction = _loc5_;
            var_278 = _loc3_.getUpdateID();
            var_2180 = param2;
            return true;
         }
         return false;
