package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         var_77.addEventListener(WindowKeyboardEvent.const_126,checkEnterPress);
         var_77.addEventListener(WindowEvent.const_186,checkMaxLen);
         this.var_2221 = var_77.textBackground;
         this._orgTextBackgroundColor = var_77.textBackgroundColor;
         this.var_2222 = var_77.textColor;
      }
      ...
      {
         var_77.textBackground = this.var_2221;
         var_77.textBackgroundColor = this._orgTextBackgroundColor;
         var_77.textColor = this.var_2222;
      }
      ...
      public function displayError(param1:String) : void
      {
         ...
         if(this.var_155 == null)
         {
            ...
            IWindowContainer(var_77.parent).addChild(this.var_155);
         }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         {
            var_77.text = _loc2_.substring(0,var_1425);
         }
      }
   }
}
