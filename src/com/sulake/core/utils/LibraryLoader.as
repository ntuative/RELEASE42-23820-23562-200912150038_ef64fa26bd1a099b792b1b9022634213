package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1355:uint = 2;
      
      protected static const const_1356:uint = 1;
      
      protected static const const_1357:int = 5;
      
      protected static const const_1016:uint = 7;
      
      protected static const const_1358:uint = 4;
      
      protected static const const_1359:uint = 3;
       
      
      protected var var_872:int;
      ...
      protected var var_1297:Boolean = false;
      ...
      protected var var_306:URLRequest;
      
      protected var var_873:Boolean = false;
      
      protected var _name:String;
      
      protected var var_315:Class;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_315 = this.getDefinition(_name) as Class;
         if(var_315 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_306.url + "!");
            return;
         }
         try
         {
            xmlClass = var_315.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_418 == LibraryLoader.const_1359)
         {
            if(analyzeLibrary())
            {
               var_418 |= 0;
         ...
         if(var_418 == LibraryLoader.const_1016)
         {
            var_1297 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_872 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_306,const_1357 - var_872);
               var_1.load(var_306,_context);
               --var_872;
               return true;
            }
