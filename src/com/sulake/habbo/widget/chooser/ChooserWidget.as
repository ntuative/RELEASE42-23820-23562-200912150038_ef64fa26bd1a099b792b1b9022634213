package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserWidget extends RoomWidgetBase
   {
      ...
      private const const_1385:int = 1;
      
      private const const_1591:int = 0;
      
      private var _userChooser:ChooserView;
      
      private var var_383:ChooserView;
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChooserContentEvent.const_425:
               if(var_383 == null)
               {
                  var_383 = new ChooserView(this,"${widget.chooser.furni.title}");
               }
               if(var_383 == null)
               {
                  return;
               }
               var_383.populate(param1.items,param1.isAnyRoomController);
               break;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_425,onChooserContent);
         param1.addEventListener(RoomWidgetChooserContentEvent.const_392,onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_108,onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_544,onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_231,onUpdateUserChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_718,onUpdateUserChooser);
      ...
      {
         if(var_383 == null || !var_383.isOpen())
         {
            return;
         }
      ...
      {
         var _loc3_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_670,param1,param2);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_425,onChooserContent);
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_392,onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_108,onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_544,onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_231,onUpdateUserChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_718,onUpdateUserChooser);
      }
   }
}
