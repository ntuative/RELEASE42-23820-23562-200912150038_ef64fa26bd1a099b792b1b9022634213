package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1134:String = "default";
      
      private var var_1093:Array;
      
      private var var_899:BitmapData = null;
      
      private var var_212:int = 0;
      
      private var var_614:int = 0;
      
      private var var_1135:String = "1.1";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_170.floors.pattern)
                     {
                        var_750.push(String(_loc9_.@id));
                        var_1093.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_170.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_170.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_899 != null && var_898 != null)
         {
            setRoomImage(var_899,var_898);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_170.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_212 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_212];
                  if(_loc9_ != null)
                  {
                     var_1134 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_170.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_246];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_170.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_247];
               if(_loc13_ != null)
               {
                  var_1135 = _loc13_.@id;
               }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_174:
               ...
               if(var_281 == _activeWallpaperPatterns.length)
               {
                  var_281 = 0;
               }
               var_212 = 0;
               var_612 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_170.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_612 = _loc8_.children().length();
                  }
               }
            ...
            case const_175:
               ...
               for each(_loc9_ in var_170.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_613 = _loc9_.children().length();
                  }
               }
            ...
            case const_173:
               ...
               var_614 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_170.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_614 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1134);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1092[var_282];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1135);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1134,var_1135,64,this,"window_romantic_wide");
